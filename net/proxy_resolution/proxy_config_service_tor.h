...
#ifndef HUHI_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_
#define HUHI_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_
...
#endif  // HUHI_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_
