...
#ifndef HUHI_COMMON_NETWORK_CONSTANTS_H_
#define HUHI_COMMON_NETWORK_CONSTANTS_H_
...
extern const char kHuhiReferralsActivityPath[];
extern const char kHuhiSafeBrowsingFileCheckProxy[];
extern const char kHuhiRedirectorProxy[];
extern const char kHuhiClients4Proxy[];
extern const char kHuhiStaticProxy[];
...
extern const char kHuhiPartnerHeader[];
