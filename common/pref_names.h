...
#ifndef HUHI_COMMON_PREF_NAMES_H_
#define HUHI_COMMON_PREF_NAMES_H_
...
extern const char kHuhiThemeType[];
extern const char kUseOverriddenHuhiThemeType[];
...
extern const char kHuhiSuggestedSiteSuggestionsEnabled[];
extern const char kHuhiDarkMode[];
extern const char kOtherBookmarksMigrated[];
extern const char kHuhiShieldsSettingsVersion[];
extern const char kBinanceAccessToken[];
extern const char kBinanceRefreshToken[];
#if !BUILDFLAG(USE_GCM_FROM_PLATFORM)
extern const char kHuhiGCMChannelStatus[];
#endif
