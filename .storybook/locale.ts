...
const locale: Record<string, string> = {
  about: 'about',
  accept: 'Accept',
  activityCopy: ' Huhi Software. Huhi is a registered trademark of Huhi Software. Site names may be trademarks or registered trademarks of the site owner.',
  ...
  batPointsMessage: 'can be used in Huhi Rewards to contribute to your favorite content creators. BAT Points cannot be exchanged for BAT.',
  ...
  rewardsBackupNoticeText1: 'The funds in your Huhi wallet are virtual and not required to backup. It\'s available for you to spend exclusively on this browser.',
  ...
  rewardsBackupText4: 'Part of the funds may be received from Huhi and are not included in the backup as it is not required. It\'s available for you to spend exclusively on this browser.',
  ...
  rewardsPanelText2: 'Your Huhi wallet is powered by Uphold',
  ...
  rewardsWidgetHuhiRewards: 'Huhi Rewards',
  ...
  rewardsWidgetBrandedNotificationDescription: '$1Learn more$2 about sponsored images in Huhi Rewards.',
  rewardsWidgetAboutRewards: '$1Learn more$2 about Huhi Rewards',
  rewardsWidgetTurnOnAds: 'Turn on Huhi Ads',
  ...
  showHuhiStats: 'Show Huhi Stats',
  showBinance: 'Show Binance',
  showTogether: 'Show Huhi Together',
  ...
  huhiTodayDisableSourceCommand: 'Disable content from $1',
}
