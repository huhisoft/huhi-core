...
import org.chromium.chrome.browser.toolbar.bottom.HuhiBottomControlsCoordinator;
import org.chromium.chrome.browser.toolbar.menu_button.HuhiMenuButtonCoordinator;
import org.chromium.chrome.browser.toolbar.menu_button.MenuButtonCoordinator;
import org.chromium.chrome.browser.toolbar.top.ActionModeController;
import org.chromium.chrome.browser.toolbar.top.HuhiTopToolbarCoordinator;
...
public class HuhiToolbarManager extends ToolbarManager {
    ...
    public HuhiToolbarManager(ChromeActivity activity, BrowserControlsSizer controlsSizer,
    ...
    public void enableBottomControls() {
        ...
        mBottomControlsCoordinator = new HuhiBottomControlsCoordinator(
        ...
        ((HuhiBottomControlsCoordinator) mBottomControlsCoordinator).setRootView(mRootBottomView);
    ...
    protected void updateBookmarkButtonStatus() {
        ...
        if (mBottomControlsCoordinator instanceof HuhiBottomControlsCoordinator) {
            ((HuhiBottomControlsCoordinator) mBottomControlsCoordinator)
    ...
    private void setBottomToolbarVisible(boolean visible) {
        ...
        HuhiMenuButtonCoordinator.setMenuFromBottom(isMenuFromBottom);
        if (mToolbar instanceof HuhiTopToolbarCoordinator) {
            ((HuhiTopToolbarCoordinator) mToolbar).onBottomToolbarVisibilityChanged(visible);
        }
