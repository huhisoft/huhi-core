...
public class HuhiMenuButtonCoordinator extends MenuButtonCoordinator {
    private static final String HUHI_IS_MENU_FROM_BOTTOM = "huhi_is_menu_from_bottom";

    private Activity mActivity;

    public HuhiMenuButtonCoordinator(
    ...
    private void updateMenuButtonState() {
        HuhiToolbarLayout layout = (HuhiToolbarLayout) mActivity.findViewById(R.id.toolbar);
        assert layout != null;
        if (layout != null) {
    ...
    public static void setMenuFromBottom(boolean isMenuFromBottom) {
        ...
        prefs.edit().putBoolean(HUHI_IS_MENU_FROM_BOTTOM, isMenuFromBottom).apply();
    }

    public static boolean isMenuFromBottom() {
        SharedPreferences sharedPreferences = ContextUtils.getAppSharedPreferences();
        return sharedPreferences.getBoolean(HUHI_IS_MENU_FROM_BOTTOM, true);
    }
}
