...
public class HuhiTopToolbarCoordinator extends TopToolbarCoordinator {
    ...
    private ToolbarLayout mHuhiToolbarLayout;

    public HuhiTopToolbarCoordinator(ToolbarControlContainer controlContainer,
        ...
        mHuhiToolbarLayout = toolbarLayout;

        if (toolbarLayout instanceof ToolbarPhone) {
            if (!StartSurfaceConfiguration.isStartSurfaceEnabled()) {
                mTabSwitcherModeCoordinatorPhone = new HuhiTabSwitcherModeTTCoordinatorPhone(
    ...
    public void onBottomToolbarVisibilityChanged(boolean isVisible) {
        if (mHuhiToolbarLayout instanceof HuhiToolbarLayout) {
            ((HuhiToolbarLayout) mHuhiToolbarLayout).onBottomToolbarVisibilityChanged(isVisible);
        }
        if (mTabSwitcherModeCoordinatorPhone instanceof HuhiTabSwitcherModeTTCoordinatorPhone) {
            ((HuhiTabSwitcherModeTTCoordinatorPhone) mTabSwitcherModeCoordinatorPhone)
