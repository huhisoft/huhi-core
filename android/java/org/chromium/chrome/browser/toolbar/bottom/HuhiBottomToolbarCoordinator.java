...
public class HuhiBottomToolbarCoordinator
    ...
    private ActivityTabProvider mHuhiTabProvider;
    private Runnable mOriginalHomeButtonRunnable;
    private final ScrollingBottomViewResourceFrameLayout rootView;

    private final Context mContext = ContextUtils.getApplicationContext();

    HuhiBottomToolbarCoordinator(ScrollingBottomViewResourceFrameLayout root, ViewStub stub,
        ...
        if (mOverviewModeObserver != null) {
            ...
            mOverviewModeObserver = new EmptyOverviewModeObserver() {
                ...
                public void onOverviewModeStartedShowing(boolean showToolbar) {
                    HuhiBrowsingModeBottomToolbarCoordinator browsingModeCoordinator =
                            (HuhiBrowsingModeBottomToolbarCoordinator)mBrowsingModeCoordinator;
