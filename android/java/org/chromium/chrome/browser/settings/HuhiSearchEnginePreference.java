...
public class HuhiSearchEnginePreference extends ListFragment {
    private SearchEngineAdapter mSearchEngineAdapter;
    private boolean mPrivate;

    public HuhiSearchEnginePreference(boolean isPrivate) {
        mPrivate = isPrivate;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSearchEngineAdapter = new HuhiSearchEngineAdapter(getActivity(), mPrivate);
