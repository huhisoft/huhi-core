...
import org.chromium.chrome.browser.settings.developer.HuhiRewardsDebugPreferences;
...
public class HuhiPreferenceFragment extends PreferenceFragmentCompat {
    ...
    public void onResume() {
        ...
        if (!ChromeFeatureList.isEnabled(HuhiFeatureList.HUHI_REWARDS)
            ...
            Preference huhiRewardsDebugPreference =
                    getPreferenceScreen().findPreference(HuhiRewardsDebugPreferences.KEY);
            if (huhiRewardsDebugPreference != null) {
                getPreferenceScreen().removePreference(huhiRewardsDebugPreference);
            }
        }
    }
