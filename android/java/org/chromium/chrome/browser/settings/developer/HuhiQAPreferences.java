 ...
 */
public class HuhiQAPreferences extends HuhiPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDbUtil = HuhiDbUtil.getInstance();
                    ...
                    public void onClick(DialogInterface dialog, int button) {
                        if (button == AlertDialog.BUTTON_POSITIVE) {
                            ...
                            if (!restorePhrase.isEmpty()) {
                                HuhiRewardsNativeWorker.getInstance().RecoverWallet(
                                    restorePhrase);
                            }
                        }
                    }
    ...
    private void checkQACode() {
        ...
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int button) {
                if (button != AlertDialog.BUTTON_POSITIVE
                        || !input.getText().toString().equals(HuhiConfig.DEVELOPER_OPTIONS_CODE)) {
                    getActivity().finish();
                }
            }
        };
    ...
    private void enableMaximumAdsNumber(boolean enable) {
        if (enable) {
            ...
            sharedPreferencesEditor.apply();
            // Set max value
            HuhiRewardsNativeWorker.getInstance().SetAdsPerHour(MAX_ADS);
            return;
        }
        // Set saved values
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CHOOSE_FILE_FOR_IMPORT_REQUEST_CODE && resultCode == Activity.RESULT_OK
            ...
            try {
                ...
                Log.e(HuhiDbUtil.getTag(), "Error on preparing database file: " + e);
                return;
            }
            requestRestart(true);
        }
