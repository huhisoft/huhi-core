...
public class HuhiReferrer implements InstallReferrerStateListener {
    private static final String TAG = "HuhiReferrer";
    private static final String APP_CHROME_DIR = "app_chrome";
    private static final String PROMO_CODE_FILE_NAME = "promoCode";
    private static final String HUHI_REFERRER_RECEIVED = "huhi_referrer_received";

    private String promoCodeFilePath;
    private InstallReferrerClient referrerClient;

    private static HuhiReferrer sInstance;

    private HuhiReferrer() {}

    public static HuhiReferrer getInstance() {
        if (sInstance != null) return sInstance;
        sInstance = new HuhiReferrer();
        return sInstance;
    }

    private class InitReferrerRunnable implements Runnable {
        private Context mContext;
        private HuhiReferrer mHuhiReferrer;
        public InitReferrerRunnable(Context context, HuhiReferrer huhiReferrer) {
          mContext = context;
          mHuhiReferrer = huhiReferrer;
        }
        ...
        public void run() {
            ...
            if (!sharedPref.getBoolean(HUHI_REFERRER_RECEIVED, false) &&
                ...
                try {
                    referrerClient.startConnection(mHuhiReferrer);
        ...
        switch (responseCode) {
            case InstallReferrerResponse.OK:
                try {
                    ...
                    editor.putBoolean(HUHI_REFERRER_RECEIVED, true);
                    editor.apply();
