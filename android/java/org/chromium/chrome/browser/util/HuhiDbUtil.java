...
public class HuhiDbUtil {
    private static final String TAG = "HuhiDbUtil";
    ...
    private static HuhiDbUtil sInstance;

    private HuhiDbUtil() {
    }

    public static HuhiDbUtil getInstance() {
        if (sInstance != null)
            return sInstance;
        sInstance = new HuhiDbUtil();
        return sInstance;
    }
