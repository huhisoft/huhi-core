...
public class HuhiStatsBottomSheetDialogFragment extends BottomSheetDialogFragment {
    final public static String TAG_FRAGMENT = "HUHISTATS_FRAG";
    ...
    private TextView huhiStatsSubSectionText;
    ...
    public static HuhiStatsBottomSheetDialogFragment newInstance() {
        return new HuhiStatsBottomSheetDialogFragment();
    }
    ...
    public void show(FragmentManager manager, String tag) {
        try {
            HuhiStatsBottomSheetDialogFragment fragment = (HuhiStatsBottomSheetDialogFragment) manager.findFragmentByTag(HuhiStatsBottomSheetDialogFragment.TAG_FRAGMENT);
            ...
            Log.e("HuhiStatsBottomSheetDialogFragment", e.getMessage());
        }
    }
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        final View view = LayoutInflater.from(getContext()).inflate(R.layout.huhi_stats_bottom_sheet, null);

        emptyDataLayout = view.findViewById(R.id.huhi_stats_empty_layout);
        ...
        LinearLayout layout = view.findViewById(R.id.huhi_stats_layout);
        ...
        huhiStatsSubSectionText = layout.findViewById(R.id.huhi_stats_sub_section_text);
        ...
        ImageView btnClose = view.findViewById(R.id.huhi_stats_bottom_sheet_close);
    ...
    private void updateHuhiStatsLayoutAsync() {
        new AsyncTask<Void>() {
            ...
            protected Void doInBackground() {
                adsTrackersCount =
                    mDatabaseHelper
                    .getAllStatsWithDate(HuhiStatsUtil.getCalculatedDate(
                ...
                totalSavedBandwidth = mDatabaseHelper.getTotalSavedBandwidthWithDate(
                                          HuhiStatsUtil.getCalculatedDate("yyyy-MM-dd", selectedDuration),
                                          HuhiStatsUtil.getCalculatedDate("yyyy-MM-dd", 0));
                adsTrackersCountToCheckForMonth =
                    mDatabaseHelper
                    .getAllStatsWithDate(
                        HuhiStatsUtil.getCalculatedDate("yyyy-MM-dd", DAYS_30),
                        HuhiStatsUtil.getCalculatedDate("yyyy-MM-dd", DAYS_7))
                    .size();
                adsTrackersCountToCheckFor3Month =
                    mDatabaseHelper
                    .getAllStatsWithDate(
                        HuhiStatsUtil.getCalculatedDate("yyyy-MM-dd", DAYS_90),
                        HuhiStatsUtil.getCalculatedDate("yyyy-MM-dd", DAYS_30))
                    .size();
                return null;
            }
        ...
        new AsyncTask<Void>() {
            ...
            protected void onPostExecute(Void result) {
                ...
                if (websiteTrackers.size() > 0) {
                    ...
                    huhiStatsSubSectionText.setVisibility(View.VISIBLE);
                } else {
