...
public class OnboardingPrefManager {
    ...
    public boolean isHuhiStatsEnabled() {
        return mSharedPreferences.getBoolean(PREF_HUHI_STATS, false);
    }

    public void setHuhiStatsEnabled(boolean enabled) {
        SharedPreferences.Editor sharedPreferencesEditor = mSharedPreferences.edit();
        sharedPreferencesEditor.putBoolean(PREF_HUHI_STATS, enabled);
        sharedPreferencesEditor.apply();
    }

    public boolean isHuhiStatsNotificationEnabled() {
        return mSharedPreferences.getBoolean(PREF_HUHI_STATS_NOTIFICATION, true);
    }

    public void setHuhiStatsNotificationEnabled(boolean enabled) {
        SharedPreferences.Editor sharedPreferencesEditor = mSharedPreferences.edit();
        sharedPreferencesEditor.putBoolean(PREF_HUHI_STATS_NOTIFICATION, enabled);
        sharedPreferencesEditor.apply();
    }
    ...
    public boolean isAdsAvailable() {
        return HuhiAdsNativeHelper.nativeIsSupportedLocale(Profile.getLastUsedRegularProfile());
    }
