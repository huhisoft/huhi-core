...
public class NotificationIntent {
    ...
    private static final String URL = "https://support.huhisoft.com/hc/en-us/articles/360045401211/";
    ...
    //private static final String NOTIFICATION_TITLE = "Huhi update";
    //private static final String NOTIFICATION_TEXT = "The new Huhi browser is 22% faster";
    ...
    public static void fireNotificationIfNecessary(Context context) {
        ...
        intent.putExtra(HuhiPreferenceKeys.HUHI_UPDATE_EXTRA_PARAM, true);
    ...
    public static long GetPreferences(Context context) {
        SharedPreferences sharedPref = context.getSharedPreferences(HuhiPreferenceKeys.HUHI_NOTIFICATION_PREF_NAME, 0);

        return sharedPref.getLong(HuhiPreferenceKeys.HUHI_MILLISECONDS_NAME, 0);
    }
}
