...
public class HuhiStatsTable {
    public static final String TABLE_NAME = "huhi_stats_table";
    ...
    public HuhiStatsTable(String url, String domain, String statType, String statSite, String statSiteDomain, String timestamp) {
        mUrl = url;
        mDomain = domain;
        mStatType = statType;
        mStatSite = statSite;
