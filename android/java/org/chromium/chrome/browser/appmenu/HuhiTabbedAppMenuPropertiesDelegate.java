...
public class HuhiTabbedAppMenuPropertiesDelegate extends TabbedAppMenuPropertiesDelegate {
    private Menu mMenu;

    public HuhiTabbedAppMenuPropertiesDelegate(Context context,
    ...
    public void prepareMenu(Menu menu, AppMenuHandler handler) {
        ...
        // Huhi's items are only visible for page menu.
        ...
        if (ChromeFeatureList.isEnabled(HuhiFeatureList.HUHI_REWARDS)
            ...
            menu.add(Menu.NONE, R.id.huhi_rewards_id, 0, R.string.menu_huhi_rewards);
        }
        menu.add(Menu.NONE, R.id.exit_id, 0, R.string.menu_exit);

        if (HuhiSetDefaultBrowserNotificationService.isHuhiSetAsDefaultBrowser(mContext)) {
    ...
    public void onMenuDismissed() {
        ...
        mMenu.removeItem(R.id.huhi_rewards_id);
