...
public class HuhiThemePreferences extends ThemeSettingsFragment {

    private static final String SUPER_REFERRAL = "super_referral";

    @Override
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
        SettingsUtils.addPreferencesFromResource(this, R.xml.huhi_theme_preferences);
        ...
        HuhiRadioButtonGroupThemePreference radioButtonGroupThemePreference =
            (HuhiRadioButtonGroupThemePreference) findPreference(PREF_UI_THEME_PREF);
