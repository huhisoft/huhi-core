...
public class SuperReferralShareDialogFragment extends DialogFragment implements View.OnClickListener{
    ...
    private static final String HUHI_REF_URL = "https://huhisoft.com/r/";
    ...
    private void openShareIntent() {
        ...
        sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, HUHI_REF_URL + mNTPBackgroundImagesBridge.getSuperReferralCode());
    ...
    private void generateQRCode() {
        final String qrDataFinal = HUHI_REF_URL + mNTPBackgroundImagesBridge.getSuperReferralCode();
