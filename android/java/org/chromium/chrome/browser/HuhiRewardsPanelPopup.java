...
public class HuhiRewardsPanelPopup implements HuhiRewardsObserver, HuhiRewardsHelper.LargeIconReadyCallback {
    ...
    public static final String PREF_WAS_HUHI_REWARDS_TURNED_ON = "huhi_rewards_turned_on";
    ...
    private final HuhiRewardsPanelPopup thisObject;
    ...
    private boolean isVerifyWalletEnabled() {
        ...
        return sharedPreferences.getBoolean(HuhiRewardsPanelPopup.PREF_VERIFY_WALLET_ENABLE, false);
    }

    public HuhiRewardsPanelPopup(View anchor) {
        ...
        thisObject = this;
        mIconFetcher = new HuhiRewardsHelper(HuhiRewardsHelper.currentActiveChromeTabbedActivityTab());
        ...
        this.window.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                ...
                if (mHuhiRewardsNativeWorker != null) {
                    mHuhiRewardsNativeWorker.RemoveObserver(thisObject);
                }

                if (currentTabId != -1 && mHuhiRewardsNativeWorker != null) {
                    mHuhiRewardsNativeWorker.RemovePublisherFromMap(currentTabId);
                }

                if (mHuhiActivity != null) {
                    mHuhiActivity.OnRewardsPanelDismiss();
                }
            }
        });
        mHuhiActivity = HuhiRewardsHelper.getHuhiActivity();
        mActivity = HuhiRewardsHelper.getChromeTabbedActivity();
        mHuhiRewardsNativeWorker = HuhiRewardsNativeWorker.getInstance();
        if (mHuhiRewardsNativeWorker != null) {
            mHuhiRewardsNativeWorker.AddObserver(thisObject);
        }
    ...
    private void CreateUpdateBalanceTask() {
        balanceUpdater.schedule(new TimerTask() {
            @Override
            public void run() {
                if (thisObject.mHuhiRewardsNativeWorker == null) {
                    return;
                }
        ...
        if (btAutoContribute != null) {
            autoContributeSwitchListener = new OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView,
                                             boolean isChecked) {
                    thisObject.mHuhiRewardsNativeWorker.IncludeInAutoContribution(currentTabId, !isChecked);
                }
            };
        ...
        if (btSendATip != null) {
            btSendATip.setOnClickListener((new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(ContextUtils.getApplicationContext(), HuhiRewardsSiteBannerActivity.class);
                    intent.putExtra(HuhiRewardsSiteBannerActivity.TAB_ID_EXTRA, currentTabId);
                    mActivity.startActivityForResult(intent, HuhiActivity.SITE_BANNER_REQUEST_CODE);

                    //HuhiRewardsPanelPopup is not an Activity and onActivityResult is not available
        ...
        if (tvCloseNotification != null) {
            tvCloseNotification.setOnClickListener((new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mHuhiRewardsNativeWorker != null) {
                        mHuhiRewardsNativeWorker.DeleteNotification(currentNotificationId);
                    }
                }
            }));
        }
    ...
    private void SetRewardsSummaryMonthYear() {
        ...
        String currentMonth = HuhiRewardsHelper.getCurrentMonth(Calendar.getInstance(),
                              this.root.getResources(), true);
        String currentYear = HuhiRewardsHelper.getCurrentYear(this.root.getResources());
        String rewardsText = this.root.getResources().getString(R.string.huhi_ui_rewards_summary);
        rewardsText += "\n" + String.format(this.root.getResources().getString(R.string.huhi_ui_month_year), currentMonth,
                                            currentYear);
    ...
    public void ShowRewardsSummary() {
        if (mHuhiRewardsNativeWorker != null) {
            ...
            mHuhiRewardsNativeWorker.GetCurrentBalanceReport();
        }
    }
    ...
    class PublisherFetchTimer extends TimerTask {
        ...
        public void run() {
            ...
            mActivity.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    thisObject.mHuhiRewardsNativeWorker.GetPublisherInfo(tabId, url);
                }
            });
    ...
    public class DonationsAdapter extends BaseAdapter implements SpinnerAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            TextView tv;
            if (null == view) {
                tv = (TextView)inflater.inflate(R.layout.huhi_rewards_spinnner_item, null);
            } else {
                tv = (TextView)view;
            }
        ...
        public View getDropDownView(int position, View convertView, ViewGroup parent) {
            //read USD rate
            double usdrate = mHuhiRewardsNativeWorker.GetWalletRate();

            TextView tv;
            if (null == convertView) {
                tv = (TextView)inflater.inflate(R.layout.huhi_rewards_spinnner_item_dropdown, null);
            } else {
    ...
    private boolean IsValidNotificationType(int type, int argsNum) {
        ...
        switch (type) {
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_AUTO_CONTRIBUTE:
            valid  = (argsNum >= 4) ? true : false;
            break;
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_VERIFIED_PUBLISHER:
            valid  = (argsNum >= 1) ? true : false;
            break;
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_GRANT:
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_GRANT_ADS:
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_INSUFFICIENT_FUNDS:
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_BACKUP_WALLET:
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_TIPS_PROCESSED:
    ...
    private void ShowNotification(String id, int type, long timestamp,
        ...
        if ( !IsValidNotificationType (type, args.length) && mHuhiRewardsNativeWorker != null) {
        ...
        String currentMonth = HuhiRewardsHelper.getCurrentMonth(calTime,
        ...
        mClaimInProcess = mHuhiRewardsNativeWorker.IsGrantClaimInProcess();
        if (mClaimInProcess) {
            HuhiRewardsHelper.crossfade(btClaimOk, claim_progress, View.GONE, 1f, HuhiRewardsHelper.CROSS_FADE_DURATION);
        } else {
            btClaimOk.setEnabled(true);
            HuhiRewardsHelper.crossfade(claim_progress, btClaimOk, View.GONE, 1f, HuhiRewardsHelper.CROSS_FADE_DURATION);
        }
        ...
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_AUTO_CONTRIBUTE:
            ...
            case AUTO_CONTRIBUTE_SUCCESS:
                ...
                title = root.getResources().getString(R.string.huhi_ui_rewards_contribute);
                ...
                if (splittedValue.length != 0 && splittedValue[0].length() >= 18) {
                    value = HuhiRewardsHelper.probiToDouble(args[3]);
                ...
                description = String.format(
                                  root.getResources().getString(R.string.huhi_ui_rewards_contribute_description),
            ...
            case AUTO_CONTRIBUTE_NOT_ENOUGH_FUNDS:
                ...
                description =
                    root.getResources().getString(R.string.huhi_ui_notification_desc_no_funds);
                break;
            case AUTO_CONTRIBUTE_TIPPING_ERROR:
                ...
                description =
                    root.getResources().getString(R.string.huhi_ui_notification_desc_tip_error);
                break;
            default:
                title = "";
                notification_icon.setImageResource(R.drawable.icon_error_notification);
                hl.setBackgroundResource(R.drawable.notification_header_error);
                description =
                    root.getResources().getString(R.string.huhi_ui_notification_desc_contr_error);
            }
            if (title.isEmpty()) {
        ...
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_GRANT:
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_GRANT_ADS:
            btClaimOk.setText(root.getResources().getString(R.string.huhi_ui_claim));

            int grant_icon_id = (HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_GRANT == type ) ?
                                R.drawable.grant_icon : R.drawable.notification_icon;
            notification_icon.setImageResource(grant_icon_id);

            title = (HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_GRANT == type ) ?
                    (isAnonWallet ? root.getResources().getString(R.string.huhi_ui_new_point_grant) : root.getResources().getString(R.string.huhi_ui_new_token_grant)) :
                    root.getResources().getString(R.string.notification_category_group_huhi_ads);

            description = (HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_GRANT == type ) ?
                          String.format(root.getResources().getString(R.string.huhi_ui_new_grant), isAnonWallet ? root.getResources().getString(R.string.point) : root.getResources().getString(R.string.token)) :
                          root.getResources().getString(R.string.huhi_ads_you_earned);
            break;
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_INSUFFICIENT_FUNDS:
            btClaimOk.setText(root.getResources().getString(R.string.ok));
            notification_icon.setImageResource(R.drawable.notification_icon);
            title = root.getResources().getString(R.string.huhi_ui_insufficient_funds_msg);
            description = root.getResources().getString(R.string.huhi_ui_insufficient_funds_desc);
            break;
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_BACKUP_WALLET:
            btClaimOk.setText(root.getResources().getString(R.string.ok));
            notification_icon.setImageResource(R.drawable.notification_icon);
            title = root.getResources().getString(R.string.huhi_ui_backup_wallet_msg);
            description = root.getResources().getString(R.string.huhi_ui_backup_wallet_desc);
            break;
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_TIPS_PROCESSED:
            btClaimOk.setText(root.getResources().getString(R.string.ok));
            title = root.getResources().getString(R.string.huhi_ui_contribution_tips);
            description = root.getResources().getString(R.string.huhi_ui_tips_processed_notification);
            notification_icon.setImageResource(R.drawable.contribute_icon);
            break;
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_ADS_ONBOARDING:
        ...
        case HuhiRewardsNativeWorker.REWARDS_NOTIFICATION_VERIFIED_PUBLISHER:
            ...
            btClaimOk.setText(root.getResources().getString(R.string.ok));
            title = root.getResources().getString(R.string.huhi_ui_pending_contribution_title);
            description = root.getResources().getString(R.string.huhi_ui_verified_publisher_notification, pubName);
            notification_icon.setImageResource(R.drawable.contribute_icon);
            break;
        case REWARDS_NOTIFICATION_NO_INTERNET:
            title = "";
            notification_icon.setImageResource(R.drawable.icon_error_notification);
            hl.setBackgroundResource(R.drawable.notification_header_error);
            description = "<b>" + root.getResources().getString(R.string.huhi_rewards_local_uh_oh)
                          + "</b> " + root.getResources().getString(R.string.huhi_rewards_local_server_not_responding);
            btClaimOk.setVisibility(View.GONE);
        ...
        case REWARDS_PROMOTION_CLAIM_ERROR:
            ...
            description = "<b>" +
                          root.getResources().getString(
                              R.string.huhi_rewards_local_general_grant_error_title)
                          + "</b>";
        ...
        Spanned toInsert = HuhiRewardsHelper.spannedFromHtmlString(stringToInsert);
        tv.setText(toInsert);
    ...
    private void SetNotificationButtoClickListener() {
        Button btClaimOk = (Button)root.findViewById(R.id.br_claim_button);
        String strAction = (btClaimOk != null && mHuhiRewardsNativeWorker != null ) ? btClaimOk.getText().toString() : "";
        ...
        } else if (strAction.equals(root.getResources().getString(R.string.huhi_ui_claim))) {
            btClaimOk.setOnClickListener( new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ...
                    HuhiRewardsHelper.crossfade(btClaimOk, fadein, View.GONE, 1f, HuhiRewardsHelper.CROSS_FADE_DURATION);

                    mHuhiRewardsNativeWorker.GetGrant(promId);
                    walletDetailsReceived = false; //re-read wallet status
                    EnableWalletDetails(false);
                }
            });
        } else if (strAction.equals(root.getResources().getString(R.string.huhi_ui_turn_on_ads))) {
            btClaimOk.setOnClickListener( new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mHuhiRewardsNativeWorker.DeleteNotification(currentNotificationId);
    ...
    private void EnableWalletDetails(boolean enable) {
        ...
        HuhiRewardsHelper.crossfade(fadeout, fadein, View.GONE, 1f, HuhiRewardsHelper.CROSS_FADE_DURATION);

        View usd = root.findViewById(R.id.br_usd_wallet_layout);
        if (enable) {
            HuhiRewardsHelper.crossfade(null, usd, 0, 1f, HuhiRewardsHelper.CROSS_FADE_DURATION );
        } else {
            HuhiRewardsHelper.crossfade(usd, null, View.INVISIBLE, 1f, HuhiRewardsHelper.CROSS_FADE_DURATION);
        }
    }
    ...
    public void OnPublisherInfo(int tabId) {
        ...
        String publisherFavIconURL = mHuhiRewardsNativeWorker.GetPublisherFavIconURL(currentTabId);
        Tab currentActiveTab = HuhiRewardsHelper.currentActiveChromeTabbedActivityTab();
        String url = currentActiveTab.getUrlString();
        ...
        String pubName = thisObject.mHuhiRewardsNativeWorker.GetPublisherName(currentTabId);
        String pubId = thisObject.mHuhiRewardsNativeWorker.GetPublisherId(currentTabId);
        String pubSuffix = "";
        if (pubId.startsWith(YOUTUBE_TYPE)) {
            pubSuffix = thisObject.root.getResources().getString(R.string.huhi_ui_on_youtube);
        } else if (pubName.startsWith(TWITCH_TYPE)) {
            pubSuffix = thisObject.root.getResources().getString(R.string.huhi_ui_on_twitch);
        }
        ...
        String percent = Integer.toString(thisObject.mHuhiRewardsNativeWorker.GetPublisherPercent(currentTabId)) + "%";
        tv.setText(percent);
        if (btAutoContribute != null) {
            btAutoContribute.setOnCheckedChangeListener(null);
            btAutoContribute.setChecked(!thisObject.mHuhiRewardsNativeWorker.GetPublisherExcluded(currentTabId));
            btAutoContribute.setOnCheckedChangeListener(autoContributeSwitchListener);
        }
        ...
        thisObject.mHuhiRewardsNativeWorker.GetRecurringDonations();

        mHuhiRewardsNativeWorker.GetAutoContributeProperties();
    }
    ...
    public void OnGetCurrentBalanceReport(double[] report) {
        ...
        for (int i = 0; i < report.length; i++) {
            ...
            case BALANCE_REPORT_GRANTS:
                ...
                tvTitle.setText(isAnonWallet ? HuhiRewardsPanelPopup.this.root.getResources().getString(R.string.huhi_ui_point_grant_claimed) : HuhiRewardsPanelPopup.this.root.getResources().getString(R.string.huhi_ui_token_grant_claimed));
            ...
            if (tvTitle != null && tv != null && tvUSD != null &&
                ...
                Spanned toInsert = HuhiRewardsHelper.spannedFromHtmlString(text);
                tv.setText(toInsert);
        ...
        mHuhiRewardsNativeWorker.GetPendingContributionsTotal();
    }
        ...
        if (amount > 0.0) {
            String non_verified_summary =
                String.format(root.getResources().getString(
                                  R.string.huhi_ui_reserved_amount_text), String.format("%.3f", amount), batPointsText) +
                " <font color=#73CBFF>" + root.getResources().getString(R.string.learn_more) +
                ".</font>";
            Spanned toInsert = HuhiRewardsHelper.spannedFromHtmlString(non_verified_summary);
    ...
    public void OnRecurringDonationUpdated() {
        String pubId = mHuhiRewardsNativeWorker.GetPublisherId(currentTabId);
        mPubInReccuredDonation = mHuhiRewardsNativeWorker.IsCurrentPublisherInRecurrentDonations(pubId);
        ...
        if (mAutoContributeEnabled || mPubInReccuredDonation) {
            ...
            if (mAutoContributeEnabled) {
                ...
                root.findViewById(R.id.huhi_ui_auto_contribute_separator_top).setVisibility(View.VISIBLE);
                root.findViewById(R.id.huhi_ui_auto_contribute_separator_bottom).setVisibility(View.VISIBLE);
            }

            //Temporary commented out due to dropdown spinner inflating issue on PopupWindow (API 24)
            /*
            if (mPubInReccuredDonation){
                double amount  = mHuhiRewardsNativeWorker.GetPublisherRecurrentDonationAmount(pubId);
    ...
    public void OnRewardsParameters(int errorCode) {
        ...
        if (errorCode == HuhiRewardsNativeWorker.LEDGER_OK) {
            ...
            if (mHuhiRewardsNativeWorker != null) {
                ...
                double usdValue = walletBalance * mHuhiRewardsNativeWorker.GetWalletRate();
                String usdText =
                    String.format(this.root.getResources().getString(R.string.huhi_ui_usd),
        ...
        } else if (errorCode == HuhiRewardsNativeWorker.LEDGER_ERROR) {   // No Internet connection
            String args[] = {};
    ...
    private void SetVerifyWalletControl(@WalletStatus final int status) {
        ...
        if (!annonwallet) {
            ...
            switch (status) {
            case HuhiRewardsExternalWallet.NOT_CONNECTED:
                rightDrawable = R.drawable.disclosure;
                text = R.string.huhi_ui_wallet_button_unverified;
                btnVerifyWallet.setCompoundDrawablesWithIntrinsicBounds(0, 0, rightDrawable, 0);
                break;
            case HuhiRewardsExternalWallet.CONNECTED:
                rightDrawable = R.drawable.verified_disclosure;
                text = R.string.huhi_ui_wallet_button_unverified;
                btnVerifyWallet.setCompoundDrawablesWithIntrinsicBounds(0, 0, rightDrawable, 0);
                break;
            case HuhiRewardsExternalWallet.PENDING:
                ...
                btnVerifyWallet.setCompoundDrawablesWithIntrinsicBounds(0, 0, rightDrawable, 0);
                break;
            case HuhiRewardsExternalWallet.VERIFIED:
                editor.putBoolean(PREF_VERIFY_WALLET_ENABLE, true);
                editor.apply();

                leftDrawable = R.drawable.uphold_white;
                rightDrawable = R.drawable.verified_disclosure;
                text = R.string.huhi_ui_wallet_button_verified;
                ...
                break;
            case HuhiRewardsExternalWallet.DISCONNECTED_NOT_VERIFIED:
            case HuhiRewardsExternalWallet.DISCONNECTED_VERIFIED:
                leftDrawable = R.drawable.uphold_white;
                text = R.string.huhi_ui_wallet_button_disconnected;
    ...
    private void SetAddFundsBtnClickHandler(@WalletStatus final int status) {
        Button btnAddFunds = (Button)root.findViewById(R.id.br_add_funds);
        if (status != HuhiRewardsExternalWallet.VERIFIED) {
        ...
        btnAddFunds.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dismiss();
                mHuhiActivity.openNewOrSelectExistingTab (mExternal_wallet.mAdd_url);
            }
        }));
    }
            ...
            public void onClick(View v) {
                ...
                case HuhiRewardsExternalWallet.VERIFIED:
                    if (walletBalance < WALLET_BALANCE_LIMIT && !isVerifyWalletEnabled()) {
                        ...
                        int requestCode =
                            (status == HuhiRewardsExternalWallet.NOT_CONNECTED) ?
                            HuhiActivity.VERIFY_WALLET_ACTIVITY_REQUEST_CODE :
                            HuhiActivity.USER_WALLET_ACTIVITY_REQUEST_CODE;
                ...
                case HuhiRewardsExternalWallet.DISCONNECTED_VERIFIED:
                    if (walletBalance < WALLET_BALANCE_LIMIT && !isVerifyWalletEnabled()) {
                        ...
                        if (!TextUtils.isEmpty(mExternal_wallet.mVerify_url)) {
                            dismiss();
                            mHuhiActivity.openNewOrSelectExistingTab (mExternal_wallet.mVerify_url);
                        }
                    }
                    break;
                default:
    ...
    private Intent BuildVerifyWalletActivityIntent(@WalletStatus final int status) {
        ...
        switch (status) {
        case HuhiRewardsExternalWallet.NOT_CONNECTED:
            clazz = HuhiRewardsVerifyWalletActivity.class;
            break;
        case HuhiRewardsExternalWallet.CONNECTED:
        case HuhiRewardsExternalWallet.PENDING:
        case HuhiRewardsExternalWallet.VERIFIED:
            clazz = HuhiRewardsUserWalletActivity.class;
            break;
        default:
            Log.e (TAG, "Unexpected external wallet status");
            return null;
        ...
        intent.putExtra(HuhiRewardsExternalWallet.ACCOUNT_URL, mExternal_wallet.mAccount_url);
        intent.putExtra(HuhiRewardsExternalWallet.ADD_URL, mExternal_wallet.mAdd_url);
    ...
    private void UpdatePublisherStatus(int pubStatus) {
        ...
        refreshPublisher.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mHuhiRewardsNativeWorker.RefreshPublisher(pubId);
            }
        }));
        if (pubStatus == HuhiRewardsPublisher.CONNECTED
        ...
        // show |huhi_ui_panel_connected_text| text if
        // publisher is CONNECTED and user doesn't have any Huhi funds (anonymous or
        // blinded wallets)
