...
public class HuhiRewardsHelper implements LargeIconBridge.LargeIconCallback{
    ...
    public HuhiRewardsHelper(Tab tab) {
        mTab = tab;
        assert mTab != null;
    ...
    static public ChromeTabbedActivity getChromeTabbedActivity() {
      return HuhiActivity.getChromeTabbedActivity();
    }

    static public HuhiActivity getHuhiActivity() {
      return HuhiActivity.getHuhiActivity();
    }

  static public String getCurrentMonth(Calendar currentTime,
      Resources resources, boolean upper_case) {
    String month = resources.getString(R.string.huhi_ui_month_jan);
    switch (currentTime.get(Calendar.MONTH)) {
      case Calendar.JANUARY:
        month = resources.getString(R.string.huhi_ui_month_jan);
        break;
      case Calendar.FEBRUARY:
        month = resources.getString(R.string.huhi_ui_month_feb);
        break;
      case Calendar.MARCH:
        month = resources.getString(R.string.huhi_ui_month_mar);
        break;
      case Calendar.APRIL:
        month = resources.getString(R.string.huhi_ui_month_apr);
        break;
      case Calendar.MAY:
        month = resources.getString(R.string.huhi_ui_month_may);
        break;
      case Calendar.JUNE:
        month = resources.getString(R.string.huhi_ui_month_jun);
        break;
      case Calendar.JULY:
        month = resources.getString(R.string.huhi_ui_month_jul);
        break;
      case Calendar.AUGUST:
        month = resources.getString(R.string.huhi_ui_month_aug);
        break;
      case Calendar.SEPTEMBER:
        month = resources.getString(R.string.huhi_ui_month_sep);
        break;
      case Calendar.OCTOBER:
        month = resources.getString(R.string.huhi_ui_month_oct);
        break;
      case Calendar.NOVEMBER:
        month = resources.getString(R.string.huhi_ui_month_nov);
        break;
      case Calendar.DECEMBER:
        month = resources.getString(R.string.huhi_ui_month_dec);
        break;
    }
  ...
  public static Tab currentActiveChromeTabbedActivityTab() {
      ChromeTabbedActivity activity = HuhiRewardsHelper.getChromeTabbedActivity();
  ...
  public static void expandTouchArea(final View parentView, final View childView, final int extraPadding) {
    ...
    public static boolean isAnonWallet() {
      return HuhiRewardsNativeWorker.getInstance().IsAnonWallet();
    }
}
