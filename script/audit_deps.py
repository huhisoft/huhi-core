...
EXCLUDE_PATHS = [
    'build',
    os.path.join('components', 'huhi_sync', 'extension', 'huhi-sync', 'node_modules'),
    os.path.join('node_modules'),
    os.path.join('vendor', 'huhi-extension', 'node_modules'),
]
...
def parse_args():
    parser = argparse.ArgumentParser(description='Audit huhi-core npm deps')
    parser.add_argument('input_dir', nargs='?', help='Directory to check')
    parser.add_argument('--source_root', required=True,
                        help='Full path of the src/huhi directory')
