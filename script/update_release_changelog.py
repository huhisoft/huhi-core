...
def main():
    ...
    # HUHI_REPO is defined in lib/helpers.py
...
def parse_args():
    desc = "Parse Huhi Browser changelog and add markdown to release notes for tag" \
        "\n\nRequires the following ENVIRONMENT VARIABLES be set:" \
        "\n\nHUHI_GITHUB_TOKEN: Github token to update draft release if not published yet. "
