...
HUHI_SOURCE_ROOT = os.path.abspath(os.path.dirname(os.path.dirname(__file__)))
...
def check_args():
    ...
    message = 'HUHI_TRANSIFEX_USERNAME and HUHITRANSIFEX_PASSWORD or '
    'HUHI_TRANSIFEX_API_KEY must be set in npm config'
...
def main():
    ...
    source_string_path = os.path.join(HUHI_SOURCE_ROOT,
