...
def replace_cc_arg(args):
    ...
    # Get this `huhi/src/huhi/script/redirect-cc.py` script absolute location
    ...
    # Build possible huhi/chromium_src_path
    huhi_path = os.path.join(chromium_original_dir, 'huhi', 'chromium_src',
                              rel_path)
    if os.path.isfile(huhi_path):
        # Okay, we can replace
        args[index_path] = huhi_path
