...
def main():
    ...
    if not os.environ.get('npm_config_huhi_version'):
        message = ('Error: Please set the $npm_config_huhi_version'
                   'environment variable')
        exit(message)

    HUHI_VERSION = os.environ.get('npm_config_huhi_version')
...
def parse_args():
    desc = "Publish GitHub draft release" \
        ...
        "\n\nHUHI_GITHUB_TOKEN: Github token to publish release. "
