...
def main():
    ...
    # Huhi Ad Block component
    adblock_dir = os.path.join(third_party_dir, 'adblock')
    adblock_lists_dir = os.path.join(adblock_dir, 'lists')
    adblock_preamble = 'These licenses do not apply to any of the code shipped with the Huhi Browser, but may ' \
                       'apply to lists downloaded after installation for use with the Huhi Shields feature. ' \
                       'The Huhi Browser and such lists are separate and independent works.'
    ...
    # Huhi Local Data component
    local_data_dir = os.path.join(third_party_dir, 'local_data')
    local_data_lists_dir = os.path.join(local_data_dir, 'lists')
    local_data_preamble = 'These licenses do not apply to any of the code shipped with the Huhi Browser, but may ' \
                          'apply to data files downloaded after installation for use with various Huhi features. ' \
                          'The Huhi Browser and such data files are separate and independent works.'
    ...
    # Huhi New Tab UI component
    ntp_data_dir = os.path.join(components_dir, 'huhi_new_tab_ui', 'data')
    ntp_backgrounds_preamble = 'These licenses do not apply to any of the code shipped with the Huhi Browser and ' \
                               'instead apply to background images used on the new tab page. The Huhi Browser and ' \
    ...
    print('  - %s sub-components added in huhi_new_tab_ui/data/LICENSE' %
          len(ntp_backgrounds))
