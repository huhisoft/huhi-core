...
huhi_channel = os.environ.get('HUHI_CHANNEL')
...
def GenerateHuhiWidevineSigFile(paths, config, part):
...
def AddHuhiPartsForSigning(parts, config):
...
def GetHuhiSigningConfig(config_class, mac_provisioning_profile=None):
    ...
    class ProvisioningProfileCodeSignConfig(config_class):
        ...
        def distributions(self):
            return [model.Distribution(channel=huhi_channel)]
