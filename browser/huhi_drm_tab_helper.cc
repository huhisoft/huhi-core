...
HuhiDrmTabHelper::HuhiDrmTabHelper(content::WebContents* contents)
...
HuhiDrmTabHelper::~HuhiDrmTabHelper() {}

bool HuhiDrmTabHelper::ShouldShowWidevineOptIn() const {
...
void HuhiDrmTabHelper::DidStartNavigation(
...
void HuhiDrmTabHelper::OnWidevineKeySystemAccessRequest() {
...
void HuhiDrmTabHelper::OnEvent(Events event, const std::string& id) {
...
WEB_CONTENTS_USER_DATA_KEY_IMPL(HuhiDrmTabHelper)
