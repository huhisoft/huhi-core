...
class HuhiProfileManagerTest : public testing::Test {
 protected:
  class MockObserver {
   public:
  ...
  DISALLOW_COPY_AND_ASSIGN(HuhiProfileManagerTest);
};

TEST_F(HuhiProfileManagerTest, GetTorProfilePath) {
...
TEST_F(HuhiProfileManagerTest, InitProfileUserPrefs) {
  ProfileManager* profile_manager = g_browser_process->profile_manager();
  base::FilePath dest_path =
    temp_dir_.GetPath().AppendASCII(TestingProfile::kTestUserProfileDir);
  base::FilePath tor_dest_path = HuhiProfileManager::GetTorProfilePath();
...
TEST_F(HuhiProfileManagerTest, TorProfileDontEndUpAsLastProfile) {
...
TEST_F(HuhiProfileManagerTest, CreateProfilesAsync) {
  MockObserver mock_observer;
  ...
  base::FilePath tor_profile_path = HuhiProfileManager::GetTorProfilePath();
...
TEST_F(HuhiProfileManagerTest, NoWebtorrentInTorProfile) {
  base::FilePath tor_parent_profile_path =
      temp_dir_.GetPath().AppendASCII(TestingProfile::kTestUserProfileDir);
  ProfileManager* profile_manager = g_browser_process->profile_manager();
  base::FilePath tor_path = HuhiProfileManager::GetTorProfilePath();
...
TEST_F(HuhiProfileManagerTest, ProxyConfigMonitorInTorProfile) {
  ProfileManager* profile_manager = g_browser_process->profile_manager();
  base::FilePath dest_path =
      temp_dir_.GetPath().AppendASCII(TestingProfile::kTestUserProfileDir);
