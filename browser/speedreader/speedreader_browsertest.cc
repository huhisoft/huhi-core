...
#include "huhi/components/speedreader/speedreader_switches.h"
...
// disabled in https://github.com/huhisoft/huhi-browser/issues/11328
IN_PROC_BROWSER_TEST_F(SpeedReaderBrowserTest, DISABLED_SmokeTest) {
  ...
  const char kGetStyleLength[] =
      "document.getElementById(\"huhi_speedreader_style\").innerHTML.length";
