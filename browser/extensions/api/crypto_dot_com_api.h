...
#ifndef HUHI_BROWSER_EXTENSIONS_API_CRYPTO_DOT_COM_API_H_
#define HUHI_BROWSER_EXTENSIONS_API_CRYPTO_DOT_COM_API_H_
...
#endif  // HUHI_BROWSER_EXTENSIONS_API_CRYPTO_DOT_COM_API_H_
