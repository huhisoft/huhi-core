...
#include "huhi/browser/extensions/api/crypto_dot_com_api.h"
...
#include "huhi/common/extensions/api/crypto_dot_com.h"
#include "huhi/browser/crypto_dot_com/crypto_dot_com_service_factory.h"
...
bool IsCryptoDotComAPIAvailable(content::BrowserContext* context) {
  return huhi::IsRegularProfile(context);
}
