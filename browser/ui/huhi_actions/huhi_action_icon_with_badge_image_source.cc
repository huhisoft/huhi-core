...
base::Optional<int>
HuhiActionIconWithBadgeImageSource::GetCustomGraphicSize() {
  return kHuhiActionGraphicSize;
}

base::Optional<int>
HuhiActionIconWithBadgeImageSource::GetCustomGraphicXOffset() {
  return std::floor(
      (size().width() - kHuhiActionRightMargin - kHuhiActionGraphicSize) /
      2.0);
}

base::Optional<int>
HuhiActionIconWithBadgeImageSource::GetCustomGraphicYOffset() {
  return std::floor((size().height() - kHuhiActionGraphicSize) / 2.0);
}

void HuhiActionIconWithBadgeImageSource::PaintBadge(gfx::Canvas* canvas) {
  ...
  // LOG(ERROR) << "HuhiAction badge text size initial, "
  //            << "w:"
  //            << text_width
  //            << " h:"
  //            << text_height;
...
gfx::Rect HuhiActionIconWithBadgeImageSource::GetIconAreaRect() const {
