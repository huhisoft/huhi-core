...
using HuhiTabStripModelTest = InProcessBrowserTest;

IN_PROC_BROWSER_TEST_F(HuhiTabStripModelTest, MRUCyclingBasic) {
...
IN_PROC_BROWSER_TEST_F(HuhiTabStripModelTest, TabClosingWhileMRUCycling) {
  // Activate MRU cycling
  browser()->profile()->GetPrefs()->SetBoolean(kMRUCyclingEnabled, true);
