...
HuhiContentSettingPluginBubbleModel::HuhiContentSettingPluginBubbleModel(
  ...
  if (huhi::IsTorProfile(GetProfile())) {
...
void HuhiContentSettingPluginBubbleModel::OnLearnMoreClicked() {
  if (delegate())
    delegate()->ShowLearnMorePage(ContentSettingsType::PLUGINS);
}

void HuhiContentSettingPluginBubbleModel::OnCustomLinkClicked() {
  RunPluginsOnPage();
}

void HuhiContentSettingPluginBubbleModel::RunPluginsOnPage() {
