...
typedef InProcessBrowserTest HuhiAutoplayBlockedImageModelTest;

IN_PROC_BROWSER_TEST_F(HuhiAutoplayBlockedImageModelTest, CreateBubbleModel) {
  ...
  auto model = std::make_unique<HuhiAutoplayBlockedImageModel>();
