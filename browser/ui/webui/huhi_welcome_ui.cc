...
#include "huhi/components/huhi_welcome/resources/grit/huhi_welcome_generated_map.h"
...
void RecordP3AHistogram(int screen_number, bool finished) {
  ...
  UMA_HISTOGRAM_EXACT_LINEAR("Huhi.Welcome.InteractionStatus", answer, 3);
}
