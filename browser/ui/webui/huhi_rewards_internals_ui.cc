...
void RewardsInternalsDOMHandler::RegisterMessages() {
  ...
  web_ui()->RegisterMessageCallback(
      "huhi_rewards_internals.getBalance",
      base::BindRepeating(
          &RewardsInternalsDOMHandler::GetBalance,
          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "huhi_rewards_internals.getContributions",
      base::BindRepeating(
          &RewardsInternalsDOMHandler::GetContributions,
          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "huhi_rewards_internals.getPromotions",
      base::BindRepeating(
          &RewardsInternalsDOMHandler::GetPromotions,
          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "huhi_rewards_internals.getPartialLog",
      base::BindRepeating(
          &RewardsInternalsDOMHandler::GetPartialLog,
          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "huhi_rewards_internals.getFullLog",
      base::BindRepeating(
          &RewardsInternalsDOMHandler::GetFulllLog,
          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "huhi_rewards_internals.clearLog",
      base::BindRepeating(
...
void RewardsInternalsDOMHandler::OnGetRewardsInternalsInfo(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "huhi_rewards_internals.onGetRewardsInternalsInfo", info_dict);
}
...
void RewardsInternalsDOMHandler::OnGetBalance(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "huhi_rewards_internals.balance",
...
void RewardsInternalsDOMHandler::OnGetContributions(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "huhi_rewards_internals.contributions",
      std::move(list));
}
...
void RewardsInternalsDOMHandler::OnGetPromotions(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "huhi_rewards_internals.promotions",
      std::move(promotions));
}
...
void RewardsInternalsDOMHandler::OnGetPartialLog(const std::string& log) {
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "huhi_rewards_internals.partialLog",
      base::Value(log));
}
...
void RewardsInternalsDOMHandler::OnGetFulllLog(const std::string& log) {
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "huhi_rewards_internals.fullLog",
      base::Value(log));
}
...
void RewardsInternalsDOMHandler::OnGetUpholdWallet(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "huhi_rewards_internals.externalWallet",
      data);
}
...
void RewardsInternalsDOMHandler::OnGetEventLogs(ledger::type::EventLogs logs) {
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "huhi_rewards_internals.eventLogs",
      std::move(data));
}

}  // namespace

HuhiRewardsInternalsUI::HuhiRewardsInternalsUI(content::WebUI* web_ui,
                                                 const std::string& name)
    : BasicUI(web_ui,
              name,
              kHuhiRewardsInternalsGenerated,
              kHuhiRewardsInternalsGeneratedSize,
              IDR_HUHI_REWARDS_INTERNALS_HTML) {
...
HuhiRewardsInternalsUI::~HuhiRewardsInternalsUI() {
}
