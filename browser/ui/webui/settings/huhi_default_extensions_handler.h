...
#ifndef HUHI_BROWSER_UI_WEBUI_SETTINGS_HUHI_DEFAULT_EXTENSIONS_HANDLER_H_
#define HUHI_BROWSER_UI_WEBUI_SETTINGS_HUHI_DEFAULT_EXTENSIONS_HANDLER_H_
...
class HuhiDefaultExtensionsHandler : public settings::SettingsPageUIHandler {
 public:
  HuhiDefaultExtensionsHandler();
  ~HuhiDefaultExtensionsHandler() override;
...
#endif
  base::WeakPtrFactory<HuhiDefaultExtensionsHandler> weak_ptr_factory_;

  DISALLOW_COPY_AND_ASSIGN(HuhiDefaultExtensionsHandler);
};

#endif  // HUHI_BROWSER_UI_WEBUI_SETTINGS_HUHI_DEFAULT_EXTENSIONS_HANDLER_H_
