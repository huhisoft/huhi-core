...
#include "huhi/components/huhi_rewards/resources/grit/huhi_rewards_page_generated_map.h"
#else
#include "components/huhi_rewards/settings/resources/grit/huhi_rewards_settings_generated_map.h"
...
// The handler for Javascript messages for Huhi about: pages
class RewardsDOMHandler : public WebUIMessageHandler,
    public huhi_ads::AdsServiceObserver,
 ...
 private:
  ...
  void OnNotificationDeleted(
      ...
      const huhi_rewards::RewardsNotificationService::RewardsNotification&
          notification) override;
  void OnAllNotificationsDeleted(huhi_rewards::RewardsNotificationService*
  ...
  huhi_ads::AdsService* ads_service_;  // NOT OWNED
...
void RewardsDOMHandler::RegisterMessages() {
  ...
  web_ui()->RegisterMessageCallback("huhi_rewards.getRewardsParameters",
      ...
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.getAutoContributeProperties",
      base::BindRepeating(&RewardsDOMHandler::GetAutoContributeProperties,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.fetchPromotions",
      base::BindRepeating(&RewardsDOMHandler::FetchPromotions,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.claimPromotion",
  ...
  web_ui()->RegisterMessageCallback("huhi_rewards.recoverWallet",
      ...
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.getReconcileStamp",
  ...
  web_ui()->RegisterMessageCallback("huhi_rewards.excludePublisher",
      ...
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.restorePublishers",
  ...
  web_ui()->RegisterMessageCallback("huhi_rewards.getContributionAmount",
      ...
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.removeRecurringTip",
      base::BindRepeating(&RewardsDOMHandler::RemoveRecurringTip,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "huhi_rewards.getRecurringTips",
      base::BindRepeating(&RewardsDOMHandler::GetRecurringTips,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.getOneTimeTips",
      base::BindRepeating(&RewardsDOMHandler::GetOneTimeTips,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.getContributionList",
      base::BindRepeating(&RewardsDOMHandler::GetContributionList,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.getAdsData",
      base::BindRepeating(&RewardsDOMHandler::GetAdsData,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.getAdsHistory",
      base::BindRepeating(&RewardsDOMHandler::GetAdsHistory,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.toggleAdThumbUp",
      base::BindRepeating(&RewardsDOMHandler::ToggleAdThumbUp,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.toggleAdThumbDown",
      base::BindRepeating(&RewardsDOMHandler::ToggleAdThumbDown,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.toggleAdOptInAction",
      base::BindRepeating(&RewardsDOMHandler::ToggleAdOptInAction,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.toggleAdOptOutAction",
      base::BindRepeating(&RewardsDOMHandler::ToggleAdOptOutAction,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.toggleSaveAd",
      base::BindRepeating(&RewardsDOMHandler::ToggleSaveAd,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.toggleFlagAd",
      base::BindRepeating(&RewardsDOMHandler::ToggleFlagAd,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.saveAdsSetting",
      base::BindRepeating(&RewardsDOMHandler::SaveAdsSetting,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.setBackupCompleted",
      base::BindRepeating(&RewardsDOMHandler::SetBackupCompleted,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "huhi_rewards.getPendingContributionsTotal",
  ...
  web_ui()->RegisterMessageCallback(
      ...
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.getPendingContributions",
      base::BindRepeating(&RewardsDOMHandler::GetPendingContributions,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.removePendingContribution",
      base::BindRepeating(&RewardsDOMHandler::RemovePendingContribution,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "huhi_rewards.removeAllPendingContribution",
      base::BindRepeating(&RewardsDOMHandler::RemoveAllPendingContributions,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.getExcludedSites",
      base::BindRepeating(&RewardsDOMHandler::GetExcludedSites,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.fetchBalance",
  ...
  web_ui()->RegisterMessageCallback("huhi_rewards.processRewardsPageUrl",
      ...
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.disconnectWallet",
      base::BindRepeating(&RewardsDOMHandler::DisconnectWallet,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.onlyAnonWallet",
      base::BindRepeating(&RewardsDOMHandler::OnlyAnonWallet,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.getBalanceReport",
      base::BindRepeating(&RewardsDOMHandler::GetBalanceReport,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.getMonthlyReport",
      base::BindRepeating(&RewardsDOMHandler::GetMonthlyReport,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.getMonthlyReportIds",
      base::BindRepeating(&RewardsDOMHandler::GetAllMonthlyReportIds,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("huhi_rewards.getCountryCode",
...
void RewardsDOMHandler::Init() {
  ...
  ads_service_ = huhi_ads::AdsServiceFactory::GetForProfile(profile);
  if (ads_service_) {
...
void RewardsDOMHandler::OnGetAutoContributeProperties(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
    "huhi_rewards.autoContributeProperties",
    values);
}
...
void RewardsDOMHandler::OnFetchPromotions(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.promotions", dict);
}
...
void RewardsDOMHandler::ClaimPromotion(const base::ListValue* args) {
  ...
  rewards_service_->ClaimPromotion(
      ...
      base::Bind(&RewardsDOMHandler::OnClaimPromotion,
          ...
          promotion_id));
#else
  // No need for a callback. The UI receives "huhi_rewards.promotionFinish".
  huhi_rewards::AttestPromotionCallback callback = base::DoNothing();
...
void RewardsDOMHandler::OnRecoverWallet(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
        "huhi_rewards.recoverWalletData",
        base::Value(static_cast<int>(result)));
}
...
void RewardsDOMHandler::OnGetReconcileStamp(uint64_t reconcile_stamp) {
  if (web_ui()->CanCallJavascript()) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.reconcileStamp",
        base::Value(stamp));
  }
}
...
void RewardsDOMHandler::OnExcludedSitesChanged(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.excludedSiteChanged");
}
...
void RewardsDOMHandler::OnNotificationDeleted(
  ...
  if (notification.type_ ==
      huhi_rewards::RewardsNotificationService::REWARDS_NOTIFICATION_GRANT
    ...
    web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.grantFinish", finish);
  }
#endif
}
...
void RewardsDOMHandler::OnGetContributionAmount(double amount) {
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.contributionAmount",
        base::Value(amount));
  }
}
...
void RewardsDOMHandler::OnReconcileComplete(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "huhi_rewards.reconcileComplete",
      complete);
}
...
void RewardsDOMHandler::OnGetRecurringTips(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.recurringTips",
                                         *publishers);
}
...
void RewardsDOMHandler::GetAdsData(const base::ListValue *args) {
  ...
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.adsData", ads_data);
}
...
void RewardsDOMHandler::OnGetAdsHistory(const base::ListValue& ads_history) {
  ...
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.adsHistory",
                                         ads_history);
}
...
void RewardsDOMHandler::OnToggleAdThumbUp(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.onToggleAdThumbUp",
                                         result);
}
...
void RewardsDOMHandler::OnToggleAdThumbDown(
  ...
  result.SetKey("creativeInstanceId", base::Value(creative_instance_id));
  result.SetKey("action", base::Value(action));
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.onToggleAdThumbDown",
                                         result);
}
...
void RewardsDOMHandler::OnToggleAdOptInAction(const std::string& category,
  ...
  result.SetKey("action", base::Value(action));
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.onToggleAdOptInAction",
                                         result);
}
...
void RewardsDOMHandler::OnToggleAdOptOutAction(const std::string& category,
  ...
  result.SetKey("category", base::Value(category));
  result.SetKey("action", base::Value(action));
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.onToggleAdOptOutAction",
                                         result);
}
...
void RewardsDOMHandler::OnToggleSaveAd(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.onToggleSaveAd",
                                         result);
}
...
void RewardsDOMHandler::OnToggleFlagAd(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.onToggleFlagAd",
                                         result);
}
...
void RewardsDOMHandler::OnGetPendingContributionsTotal(double amount) {
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe(
        "huhi_rewards.pendingContributionTotal", base::Value(amount));
  }
}
...
void RewardsDOMHandler::OnPendingContributionSaved(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "huhi_rewards.onPendingContributionSaved",
      base::Value(static_cast<int>(result)));
}
...
void RewardsDOMHandler::OnGetTransactionHistory(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "huhi_rewards.transactionHistory", history);
}
...
void RewardsDOMHandler::OnTransactionHistoryChanged(
  ...
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe(
        "huhi_rewards.transactionHistoryChanged");
  }
}
...
void RewardsDOMHandler::OnRecurringTipSaved(
  ...
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe(
        "huhi_rewards.recurringTipSaved", base::Value(success));
  }
}
...
void RewardsDOMHandler::OnRecurringTipRemoved(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "huhi_rewards.recurringTipRemoved", base::Value(success));
}
...
void RewardsDOMHandler::OnGetPendingContributions(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "huhi_rewards.pendingContributions",
      *contributions);
}
...
void RewardsDOMHandler::OnPendingContributionRemoved(
  ...
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe(
        "huhi_rewards.onRemovePendingContribution",
        base::Value(static_cast<int>(result)));
  }
}
...
void RewardsDOMHandler::OnFetchBalance(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.balance", data);
}
...
void RewardsDOMHandler::OnGetExternalWallet(
  ...
  if (web_ui()->CanCallJavascript()) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.externalWallet",
                                           data);
  }
}
...
void RewardsDOMHandler::OnProcessRewardsPageUrl(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.processRewardsPageUrl",
                                         data);
}
...
void RewardsDOMHandler::OnUnblindedTokensReady(
  ...
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.unblindedTokensReady");
}
...
void RewardsDOMHandler::ReconcileStampReset() {
  ...
  web_ui()->CallJavascriptFunctionUnsafe("huhi_rewards.reconcileStampReset");
}
...
void RewardsDOMHandler::GetCountryCode(const base::ListValue* args) {
  ...
  const std::string country_code = huhi_l10n::GetCountryCode(locale);

  web_ui()->CallJavascriptFunctionUnsafe(
      "huhi_rewards.countryCode", base::Value(country_code));
}
...
HuhiRewardsPageUI::HuhiRewardsPageUI(content::WebUI* web_ui,
    ...
    : BasicUI(web_ui,
              name,
#if defined(HUHI_CHROMIUM_BUILD)
              kHuhiRewardsPageGenerated,
              kHuhiRewardsPageGeneratedSize,
#else
              kHuhiRewardsSettingsGenerated,
...
HuhiRewardsPageUI::~HuhiRewardsPageUI() {}
