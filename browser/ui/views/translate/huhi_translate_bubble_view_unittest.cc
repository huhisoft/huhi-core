...
class MockHuhiTranslateBubbleView : public HuhiTranslateBubbleView {
 public:
  MockHuhiTranslateBubbleView(views::View* anchor_view,
                               std::unique_ptr<TranslateBubbleModel> model,
                               translate::TranslateErrors::Type error_type,
                               content::WebContents* web_contents)
    : HuhiTranslateBubbleView(anchor_view,
                               std::move(model),
                               error_type,
                               web_contents)
  ...
  ~MockHuhiTranslateBubbleView() override {
  }
...
class HuhiTranslateBubbleViewTest : public ChromeViewsTestBase {
 public:
  HuhiTranslateBubbleViewTest() {}
 ...
 protected:
  ...
  void CreateAndShowBubble() {
    ...
    bubble_ = new MockHuhiTranslateBubbleView(
  ...
  MockHuhiTranslateBubbleView* bubble_;
  base::test::ScopedFeatureList scoped_feature_list_;
};

TEST_F(HuhiTranslateBubbleViewTest, HuhiBeforeTranslateView) {
  CreateAndShowBubble();
...
TEST_F(HuhiTranslateBubbleViewTest, TranslateButton) {
  CreateAndShowBubble();
...
TEST_F(HuhiTranslateBubbleViewTest, CancelButton) {
  CreateAndShowBubble();
...
TEST_F(HuhiTranslateBubbleViewTest, ReturnKey) {
  CreateAndShowBubble();
  EXPECT_FALSE(mock_model_->translate_called_);
  EXPECT_FALSE(bubble_->install_google_translate_called());
