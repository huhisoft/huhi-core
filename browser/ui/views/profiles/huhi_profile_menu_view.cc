...
void HuhiProfileMenuView::BuildIdentity() {
...
void HuhiProfileMenuView::BuildAutofillButtons() {}

// We don't want to show any Chromium sync info.
void HuhiProfileMenuView::BuildSyncInfo() {}

// We don't want feature buttons to manage google account
void HuhiProfileMenuView::BuildFeatureButtons() {
  Profile* profile = browser()->profile();
...
gfx::ImageSkia HuhiProfileMenuView::GetSyncIcon() const {
  // We don't need sync overlay.
  return gfx::ImageSkia();
}

void HuhiProfileMenuView::OnExitProfileButtonClicked() {
