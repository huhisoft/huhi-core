...
class HuhiProfileMenuViewTest : public InProcessBrowserTest {
 public:
  HuhiProfileMenuViewTest() = default;
  ~HuhiProfileMenuViewTest() override = default;
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(HuhiProfileMenuViewTest);
};

IN_PROC_BROWSER_TEST_F(HuhiProfileMenuViewTest, TestCurrentProfileView) {
  OpenProfileMenuView();
