...
HuhiBrowserTabStripController::HuhiBrowserTabStripController(
    TabStripModel* model,
...
void HuhiBrowserTabStripController::ShowContextMenuForTab(
    Tab* tab,
    const gfx::Point& p,
    ui::MenuSourceType source_type) {
  BrowserView* browser_view =
      BrowserView::GetBrowserViewForBrowser(browser());
  context_menu_contents_ = std::make_unique<HuhiTabContextMenuContents>(
      tab,
      this,
