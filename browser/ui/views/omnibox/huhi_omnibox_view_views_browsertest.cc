...
class HuhiOmniboxViewViewsTest : public InProcessBrowserTest {
 public:
...
// Load huhi url and check copied url also has huhi scheme.
IN_PROC_BROWSER_TEST_F(HuhiOmniboxViewViewsTest, CopyURLToClipboardTest) {
  const std::string test_url("huhi://version/");
