...
class HuhiDevToolsUIBindingsBrowserTest : public InProcessBrowserTest {
 public:
...
IN_PROC_BROWSER_TEST_F(HuhiDevToolsUIBindingsBrowserTest, ThemeTest) {
  ...
  auto* devtools_ui_bindings = new HuhiDevToolsUIBindings(web_contents);
  DCHECK(devtools_ui_bindings);
  devtools_ui_bindings->GetPreferences(
      base::Bind(&HuhiDevToolsUIBindingsBrowserTest::GetPreferenceCallback,
