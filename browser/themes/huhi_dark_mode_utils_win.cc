...
namespace ui {
// This resets dark mode to os theme when user changes huhi theme from
// dark or light to Same as Windows by using the value of registry because
// we changed ui::NativeTheme::dark_mode_ explicitly for using huhi theme
// like a system theme.
...
void SetSystemDarkMode(HuhiDarkModeType type) {
  ...
  ui::IgnoreSystemDarkModeChange(
      type != dark_mode::HuhiDarkModeType::HUHI_DARK_MODE_TYPE_DEFAULT);
