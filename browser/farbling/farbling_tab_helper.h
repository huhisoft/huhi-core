...
#ifndef HUHI_BROWSER_FARBLING_FARBLING_TAB_HELPER_H_
#define HUHI_BROWSER_FARBLING_FARBLING_TAB_HELPER_H_
...
#endif  // HUHI_BROWSER_FARBLING_FARBLING_TAB_HELPER_H_
