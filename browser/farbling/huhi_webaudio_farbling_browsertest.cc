...
class HuhiWebAudioFarblingBrowserTest : public InProcessBrowserTest {
 public:
...
// https://github.com/huhisoft/huhi-browser/issues/9552
// No crash indicates a successful test.
IN_PROC_BROWSER_TEST_F(HuhiWebAudioFarblingBrowserTest,
                       CopyFromChannelNoCrash) {
  NavigateToURLUntilLoadStop(copy_from_channel_url());
}

// Tests results of farbling known values
IN_PROC_BROWSER_TEST_F(HuhiWebAudioFarblingBrowserTest, FarbleWebAudio) {
