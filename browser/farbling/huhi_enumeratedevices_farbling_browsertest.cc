...
class HuhiEnumerateDevicesFarblingBrowserTest : public InProcessBrowserTest {
 public:
  HuhiEnumerateDevicesFarblingBrowserTest()
  ...
  HuhiEnumerateDevicesFarblingBrowserTest(
      const HuhiEnumerateDevicesFarblingBrowserTest&) = delete;
  HuhiEnumerateDevicesFarblingBrowserTest& operator=(
      const HuhiEnumerateDevicesFarblingBrowserTest&) = delete;

  ~HuhiEnumerateDevicesFarblingBrowserTest() override {}
...
IN_PROC_BROWSER_TEST_F(HuhiEnumerateDevicesFarblingBrowserTest,
