...
class HuhiDeviceMemoryFarblingBrowserTest : public InProcessBrowserTest {
 public:
  HuhiDeviceMemoryFarblingBrowserTest()
  ...
  HuhiDeviceMemoryFarblingBrowserTest(
      const HuhiDeviceMemoryFarblingBrowserTest&) = delete;
  HuhiDeviceMemoryFarblingBrowserTest& operator=(
      const HuhiDeviceMemoryFarblingBrowserTest&) = delete;

  ~HuhiDeviceMemoryFarblingBrowserTest() override {}
...
IN_PROC_BROWSER_TEST_F(HuhiDeviceMemoryFarblingBrowserTest,
                       FarbleDeviceMemory) {
