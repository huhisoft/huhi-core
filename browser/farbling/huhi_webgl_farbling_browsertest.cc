...
class HuhiWebGLFarblingBrowserTest : public InProcessBrowserTest {
 public:
...
IN_PROC_BROWSER_TEST_F(HuhiWebGLFarblingBrowserTest, FarbleGetParameterWebGL) {
...
IN_PROC_BROWSER_TEST_F(HuhiWebGLFarblingBrowserTest,
