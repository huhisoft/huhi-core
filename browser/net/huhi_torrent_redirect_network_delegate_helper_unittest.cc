...
class HuhiTorrentRedirectNetworkDelegateHelperTest : public testing::Test {
 public:
  HuhiTorrentRedirectNetworkDelegateHelperTest() {
    ...
    torrent_extension_url_ = GURL(
        ...
        "huhi_webtorrent2.html?https://webtorrent.io/torrents/sintel.torrent");
    ...
    non_torrent_extension_url_ = GURL(
        "chrome-extension://lgjmpdmojkpocjcopdikifhejkkjglho/extension/"
        "huhi_webtorrent2.html?https://webtorrent.io/torrents/sintel");
  }
...
TEST_F(HuhiTorrentRedirectNetworkDelegateHelperTest,
  ...
  auto request_info = std::make_shared<huhi::HuhiRequestInfo>(torrent_url());
...
TEST_F(HuhiTorrentRedirectNetworkDelegateHelperTest,
  ...
  GURL allowed_unsafe_redirect_url;
  auto request_info =
      std::make_shared<huhi::HuhiRequestInfo>(non_torrent_url());
  request_info->resource_type = blink::mojom::ResourceType::kMainFrame;
...
TEST_F(HuhiTorrentRedirectNetworkDelegateHelperTest, MimeTypeNoRedirect) {
  scoped_refptr<net::HttpResponseHeaders> orig_response_headers =
      new net::HttpResponseHeaders(std::string());
...
TEST_F(HuhiTorrentRedirectNetworkDelegateHelperTest,
  ...
  GURL allowed_unsafe_redirect_url;
  auto request_info =
      std::make_shared<huhi::HuhiRequestInfo>(torrent_viewer_url());
  request_info->initiator_url = torrent_extension_url();
  request_info->resource_type = blink::mojom::ResourceType::kMainFrame;
