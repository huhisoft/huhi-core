...
#ifndef HUHI_BROWSER_NET_HUHI_PROXYING_URL_LOADER_FACTORY_H_
#define HUHI_BROWSER_NET_HUHI_PROXYING_URL_LOADER_FACTORY_H_
...
#include "huhi/browser/net/resource_context_data.h"
...
class HuhiProxyingURLLoaderFactory
    : public network::mojom::URLLoaderFactory {
 public:
  using DisconnectCallback =
      base::OnceCallback<void(HuhiProxyingURLLoaderFactory*)>;
  ...
  class InProgressRequest : public network::mojom::URLLoader,
   ...
   private:
    ...
    std::shared_ptr<huhi::HuhiRequestInfo> ctx_;
    HuhiProxyingURLLoaderFactory* const factory_;
  ...
  ~HuhiProxyingURLLoaderFactory() override;
 ...
 private:
  friend class base::DeleteHelper<HuhiProxyingURLLoaderFactory>;
  friend class base::RefCountedDeleteOnSequence<HuhiProxyingURLLoaderFactory>;
  ...
  HuhiRequestHandler* const request_handler_;
  content::BrowserContext* browser_context_;
  const int render_process_id_;
  const int frame_tree_node_id_;
  ...
  base::WeakPtrFactory<HuhiProxyingURLLoaderFactory> weak_factory_;

  DISALLOW_COPY_AND_ASSIGN(HuhiProxyingURLLoaderFactory);
};

#endif  // HUHI_BROWSER_NET_HUHI_PROXYING_URL_LOADER_FACTORY_H_
