...
class HuhiSiteHacksNetworkDelegateBrowserTest : public InProcessBrowserTest {
 public:
  HuhiSiteHacksNetworkDelegateBrowserTest()
...
IN_PROC_BROWSER_TEST_F(HuhiSiteHacksNetworkDelegateBrowserTest,
