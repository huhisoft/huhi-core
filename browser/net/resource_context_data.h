...
#ifndef HUHI_BROWSER_NET_RESOURCE_CONTEXT_DATA_H_
#define HUHI_BROWSER_NET_RESOURCE_CONTEXT_DATA_H_
...
class ResourceContextData : public base::SupportsUserData::Data {
 public:
  ...
  static HuhiProxyingWebSocket* StartProxyingWebSocket(
  ...
  void RemoveProxy(HuhiProxyingURLLoaderFactory* proxy);
  void RemoveProxyWebSocket(HuhiProxyingWebSocket* proxy);

 private:
  ResourceContextData();

  std::unique_ptr<HuhiRequestHandler> request_handler_;
  scoped_refptr<RequestIDGenerator> request_id_generator_;

  std::set<std::unique_ptr<HuhiProxyingURLLoaderFactory>,
           base::UniquePtrComparator>
      proxies_;

  std::set<std::unique_ptr<HuhiProxyingWebSocket>,
           base::UniquePtrComparator>
      websocket_proxies_;
...
#endif  // HUHI_BROWSER_NET_RESOURCE_CONTEXT_DATA_H_
