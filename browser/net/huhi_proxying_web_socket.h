...
#ifndef HUHI_BROWSER_NET_HUHI_PROXYING_WEB_SOCKET_H_
#define HUHI_BROWSER_NET_HUHI_PROXYING_WEB_SOCKET_H_
...
// Ensures that all web socket requests go through Huhi network request
// handling framework. Cargoculted from |WebRequestProxyingWebSocket|.
class HuhiProxyingWebSocket : public network::mojom::WebSocketHandshakeClient,
 ...
 public:
  ...
  using DisconnectCallback =
      base::OnceCallback<void(HuhiProxyingWebSocket*)>;

  HuhiProxyingWebSocket(
  ...
  ~HuhiProxyingWebSocket() override;

  static HuhiProxyingWebSocket* ProxyWebSocket(
 ...
 private:
  ...
  base::WeakPtrFactory<HuhiProxyingWebSocket> weak_factory_{this};
  DISALLOW_COPY_AND_ASSIGN(HuhiProxyingWebSocket);
};

#endif  // HUHI_BROWSER_NET_HUHI_PROXYING_WEB_SOCKET_H_
