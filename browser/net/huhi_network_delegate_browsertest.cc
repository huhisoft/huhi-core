...
class HuhiNetworkDelegateBrowserTest : public InProcessBrowserTest {
 public:
  HuhiNetworkDelegateBrowserTest()
  ...
  void DefaultBlockThirdPartyCookies() {
    huhi_shields::SetCookieControlType(
        content_settings(), huhi_shields::ControlType::BLOCK_THIRD_PARTY,
        GURL());
  }
  ...
  void AllowCookies(const GURL url) {
    huhi_shields::SetCookieControlType(content_settings(),
                                        huhi_shields::ControlType::ALLOW, url);
  }

  void BlockThirdPartyCookies(const GURL url) {
    huhi_shields::SetCookieControlType(
        content_settings(), huhi_shields::ControlType::BLOCK_THIRD_PARTY, url);
  }

  void BlockCookies(const GURL url) {
    huhi_shields::SetCookieControlType(content_settings(),
                                        huhi_shields::ControlType::BLOCK, url);
  }

  void ShieldsDown(const GURL url) {
    huhi_shields::SetHuhiShieldsEnabled(content_settings(), false, url);
  }
...
IN_PROC_BROWSER_TEST_F(HuhiNetworkDelegateBrowserTest, Iframe3PCookieBlocked) {
...
IN_PROC_BROWSER_TEST_F(HuhiNetworkDelegateBrowserTest, Iframe3PCookieAllowed) {
...
IN_PROC_BROWSER_TEST_F(HuhiNetworkDelegateBrowserTest, Iframe3PShieldsDown) {
...
IN_PROC_BROWSER_TEST_F(HuhiNetworkDelegateBrowserTest,
...
IN_PROC_BROWSER_TEST_F(HuhiNetworkDelegateBrowserTest, DefaultCookiesBlocked) {
