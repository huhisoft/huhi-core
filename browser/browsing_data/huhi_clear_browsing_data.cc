...
class BrowsingDataRemovalWatcher
 ...
 public:
  ...
  void ClearBrowsingDataForLoadedProfiles(
      HuhiClearBrowsingData::OnExitTestingCallback* testing_callback);
...
bool BrowsingDataRemovalWatcher::GetClearBrowsingDataOnExitSettings(
  ...
  *origin_mask = 0;
  ...
  // Note: this will also delete Huhi Shields site-specific settings.
...
HuhiClearBrowsingData::OnExitTestingCallback*
    HuhiClearBrowsingData::on_exit_testing_callback_ = nullptr;

// static
void HuhiClearBrowsingData::ClearOnExit() {
  TRACE_EVENT0("browser", "HuhiClearBrowsingData::ClearOnExit");
...
// static
void HuhiClearBrowsingData::SetOnExitTestingCallback(
