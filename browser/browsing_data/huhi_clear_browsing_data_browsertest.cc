...
using content::HuhiClearBrowsingData;
...
class HuhiClearDataOnExitTest
    : public InProcessBrowserTest,
      public HuhiClearBrowsingData::OnExitTestingCallback {
 public:
  HuhiClearDataOnExitTest() = default;
  void SetUpOnMainThread() override {
    HuhiClearBrowsingData::SetOnExitTestingCallback(this);
  }
  ...
  // HuhiClearBrowsingData::OnExitTestingCallback implementation.
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(HuhiClearDataOnExitTest);
};

IN_PROC_BROWSER_TEST_F(HuhiClearDataOnExitTest, NoPrefsSet) {
...
IN_PROC_BROWSER_TEST_F(HuhiClearDataOnExitTest, VerifyRemovalMasks) {
...
class HuhiClearDataOnExitTwoBrowsersTest : public HuhiClearDataOnExitTest {
 public:
  HuhiClearDataOnExitTwoBrowsersTest() : HuhiClearDataOnExitTest() {
    browsers_count_ = 2u;
  }
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(HuhiClearDataOnExitTwoBrowsersTest);
};

IN_PROC_BROWSER_TEST_F(HuhiClearDataOnExitTwoBrowsersTest, SameProfile) {
...
IN_PROC_BROWSER_TEST_F(HuhiClearDataOnExitTwoBrowsersTest, OneOTR) {
  // Delete browsing history on exit.
  SetDeleteBrowsingHistoryOnExit();
...
IN_PROC_BROWSER_TEST_F(HuhiClearDataOnExitTwoBrowsersTest, OneOTRExitsLast) {
  // Delete browsing history on exit.
  SetDeleteBrowsingHistoryOnExit();
  // OTR sessions don't count, so expect a single call.
  SetExepectedRemoveDataCallCount(1);
...
IN_PROC_BROWSER_TEST_F(HuhiClearDataOnExitTwoBrowsersTest, OneGuest) {
  // Delete browsing history on exit.
  SetDeleteBrowsingHistoryOnExit();
...
IN_PROC_BROWSER_TEST_F(HuhiClearDataOnExitTwoBrowsersTest, OneGuestExitsLast) {
  // Delete browsing history on exit.
  SetDeleteBrowsingHistoryOnExit();
  // Guest sessions don't count, so expect a single call.
  SetExepectedRemoveDataCallCount(1);
...
IN_PROC_BROWSER_TEST_F(HuhiClearDataOnExitTwoBrowsersTest, TwoProfiles) {
  // Delete browsing history on exit.
  SetDeleteBrowsingHistoryOnExit();
