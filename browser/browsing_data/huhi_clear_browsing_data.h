...
#ifndef HUHI_BROWSER_BROWSING_DATA_HUHI_CLEAR_BROWSING_DATA_H_
#define HUHI_BROWSER_BROWSING_DATA_HUHI_CLEAR_BROWSING_DATA_H_
...
class HuhiClearBrowsingData {
 ...
 protected:
  friend class ::HuhiClearDataOnExitTest;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(HuhiClearBrowsingData);
};

}  // namespace content

#endif  // HUHI_BROWSER_BROWSING_DATA_HUHI_CLEAR_BROWSING_DATA_H_
