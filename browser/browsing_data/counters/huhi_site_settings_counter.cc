...
HuhiSiteSettingsCounter::HuhiSiteSettingsCounter(
...
HuhiSiteSettingsCounter::~HuhiSiteSettingsCounter() = default;

int HuhiSiteSettingsCounter::CountShieldsSettings() {
...
void HuhiSiteSettingsCounter::ReportResult(ResultInt value) {
