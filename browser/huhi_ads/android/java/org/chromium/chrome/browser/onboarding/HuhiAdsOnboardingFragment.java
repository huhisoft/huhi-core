...
public class HuhiAdsOnboardingFragment extends Fragment {
    ...
    public HuhiAdsOnboardingFragment() {
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_huhi_ads_onboarding, container, false);
    ...
    private void startCountdown() {
        HuhiOnboardingNotification.cancelOnboardingNotification(getActivity());
