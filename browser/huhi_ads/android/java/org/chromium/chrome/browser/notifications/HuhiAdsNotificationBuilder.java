...
/**
 * Builds a notification according to HuhiAds spec.
 */
public class HuhiAdsNotificationBuilder extends NotificationBuilderBase {
    /**
    ...
    public HuhiAdsNotificationBuilder(Context context) {
    ...
    public NotificationBuilderBase setChannelId(String channelId) {
        return super.setChannelId(HuhiChannelDefinitions.ChannelId.HUHI_ADS);
    }
    ...
    public NotificationWrapper build(NotificationMetadata metadata) {
        ...
        RemoteViews compactView =
                new RemoteViews(mContext.getPackageName(), R.layout.web_notification_huhi_ads);
        RemoteViews bigView =
                new RemoteViews(mContext.getPackageName(), R.layout.web_notification_big_huhi_ads);
        ...
        setChannelId(HuhiChannelDefinitions.ChannelId.HUHI_ADS);
        ...
        for (RemoteViews view : new RemoteViews[] {compactView, bigView}) {
            ...
            view.setImageViewBitmap(R.id.icon, getHuhiIcon());
        ...
        String channelId =  (ApplicationStatus.hasVisibleActivities()) ?
                HuhiChannelDefinitions.ChannelId.HUHI_ADS :
                HuhiChannelDefinitions.ChannelId.HUHI_ADS_BACKGROUND;
        ...
        builder.setLargeIcon(getHuhiIcon());
    ...
    private Bitmap getHuhiIcon() {
        int largeIconId = R.drawable.btn_huhi;
