...
class HuhiPolicyTest : public InProcessBrowserTest {
 protected:
  HuhiPolicyTest() {}
  ~HuhiPolicyTest() override {}
...
class TorDisabledPolicyBrowserTest : public HuhiPolicyTest {
 public:
  TorDisabledPolicyBrowserTest() {}
  ~TorDisabledPolicyBrowserTest() override {}

  void SetUpInProcessBrowserTestFixture() override {
    HuhiPolicyTest::SetUpInProcessBrowserTestFixture();
