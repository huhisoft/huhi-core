...
#ifndef HUHI_BROWSER_BINANCE_BINANCE_SERVICE_FACTORY_H_
#define HUHI_BROWSER_BINANCE_BINANCE_SERVICE_FACTORY_H_
...
#endif  // HUHI_BROWSER_BINANCE_BINANCE_SERVICE_FACTORY_H_
