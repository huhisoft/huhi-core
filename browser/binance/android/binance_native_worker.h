...
#ifndef HUHI_BROWSER_BINANCE_ANDROID_BINANCE_NATIVE_WORKER_H_
#define HUHI_BROWSER_BINANCE_ANDROID_BINANCE_NATIVE_WORKER_H_
...
#endif  // HUHI_BROWSER_BINANCE_ANDROID_BINANCE_NATIVE_WORKER_H_
