...
// accesses resources.
class HuhiSpellingMenuObserverTest : public InProcessBrowserTest {
 public:
  HuhiSpellingMenuObserverTest();
  ...
  ~HuhiSpellingMenuObserverTest() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(HuhiSpellingMenuObserverTest);
};

HuhiSpellingMenuObserverTest::HuhiSpellingMenuObserverTest() {}

HuhiSpellingMenuObserverTest::~HuhiSpellingMenuObserverTest() {}

}  // namespace

// Tests that right-clicking not add "Ask Huhi for suggestions".
IN_PROC_BROWSER_TEST_F(HuhiSpellingMenuObserverTest,
