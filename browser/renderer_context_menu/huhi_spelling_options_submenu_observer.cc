...
HuhiSpellingOptionsSubMenuObserver::HuhiSpellingOptionsSubMenuObserver(
...
void HuhiSpellingOptionsSubMenuObserver::InitMenu(
    const content::ContextMenuParams& params) {
  // Let Chromium build the submenu.
  SpellingOptionsSubMenuObserver::InitMenu(params);

  // Assumptions:
  // 1. Use of spelling service is disabled in Huhi profile preferences.
...
void HuhiSpellingOptionsSubMenuObserver::SetGtestMode(
    HuhiSpellingOptionsSubMenuObserver::GtestMode mode) {
  gtest_mode_ = mode;
}
