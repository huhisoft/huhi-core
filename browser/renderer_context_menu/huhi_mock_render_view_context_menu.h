...
#ifndef HUHI_BROWSER_RENDERER_CONTEXT_MENU_HUHI_MOCK_RENDER_VIEW_CONTEXT_MENU_H_
#define HUHI_BROWSER_RENDERER_CONTEXT_MENU_HUHI_MOCK_RENDER_VIEW_CONTEXT_MENU_H_
...
class HuhiMockRenderViewContextMenu;
class PrefService;
class Profile;
...
// MenuObserver class.
class HuhiMockRenderViewContextMenu : public ui::SimpleMenuModel::Delegate,
 ...
 public:
  ...
  explicit HuhiMockRenderViewContextMenu(Profile* profile);
  ~HuhiMockRenderViewContextMenu() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(HuhiMockRenderViewContextMenu);
};

#endif  // HUHI_BROWSER_RENDERER_CONTEXT_MENU_HUHI_MOCK_RENDER_VIEW_CONTEXT_MENU_H_
