...
#ifndef HUHI_BROWSER_TOR_TOR_PROFILE_SERVICE_H_
#define HUHI_BROWSER_TOR_TOR_PROFILE_SERVICE_H_
...
class HuhiAppMenuBrowserTestWithTorDisabled;
...
#endif  // HUHI_BROWSER_TOR_TOR_PROFILE_SERVICE_H_
