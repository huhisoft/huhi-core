...
#ifndef HUHI_BROWSER_TOR_TOR_LAUNCHER_SERVICE_OBSERVER_H_
#define HUHI_BROWSER_TOR_TOR_LAUNCHER_SERVICE_OBSERVER_H_
...
#endif  // HUHI_BROWSER_TOR_TOR_LAUNCHER_SERVICE_OBSERVER_H_
