...
#ifndef HUHI_BROWSER_TOR_ONION_LOCATION_NAVIGATION_THROTTLE_DELEGATE_H_
#define HUHI_BROWSER_TOR_ONION_LOCATION_NAVIGATION_THROTTLE_DELEGATE_H_
...
#endif  // HUHI_BROWSER_TOR_ONION_LOCATION_NAVIGATION_THROTTLE_DELEGATE_H_
