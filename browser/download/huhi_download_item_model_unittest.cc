...
class HuhiDownloadItemModelTest : public testing::Test {
 public:
  HuhiDownloadItemModelTest() : model_(&item_), huhi_model_(&model_) {}
  ~HuhiDownloadItemModelTest() override {}
 ...
 protected:
  ...
  HuhiDownloadItemModel& model() { return huhi_model_; }
...
TEST_F(HuhiDownloadItemModelTest, GetOriginUrlText) {
...
TEST_F(HuhiDownloadItemModelTest, GetTooltipText) {
