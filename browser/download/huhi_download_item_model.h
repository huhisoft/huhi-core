...
#ifndef HUHI_BROWSER_DOWNLOAD_HUHI_DOWNLOAD_ITEM_MODEL_H_
#define HUHI_BROWSER_DOWNLOAD_HUHI_DOWNLOAD_ITEM_MODEL_H_
...
// extended functionality, HuhiDownloadItemView will have this model as
// a member.
class HuhiDownloadItemModel {
 public:
  // Constructs a HuhiDownloadItemModel that encapsulates DownloadItemModel.
  explicit HuhiDownloadItemModel(DownloadUIModel* model);
  ~HuhiDownloadItemModel();
  ...
  DISALLOW_COPY_AND_ASSIGN(HuhiDownloadItemModel);
};

#endif  // HUHI_BROWSER_DOWNLOAD_HUHI_DOWNLOAD_ITEM_MODEL_H_
