...
#include "huhi/browser/importer/huhi_external_process_importer_host.h"
...
HuhiExternalProcessImporterHost::HuhiExternalProcessImporterHost()
    : ExternalProcessImporterHost(),
      weak_ptr_factory_(this) {}
HuhiExternalProcessImporterHost::~HuhiExternalProcessImporterHost() = default;

#if BUILDFLAG(ENABLE_EXTENSIONS)
void HuhiExternalProcessImporterHost::LaunchExtensionsImport() {
  ...
  base::PostTaskAndReplyWithResult(
      ...
      base::BindOnce(
          &HuhiExternalProcessImporterHost::OnGetChromeExtensionsList,
          weak_ptr_factory_.GetWeakPtr()));
}

void HuhiExternalProcessImporterHost::OnGetChromeExtensionsList(
...
void HuhiExternalProcessImporterHost::NotifyImportEnded() {
  if (!cancelled_)
