...
#ifndef HUHI_BROWSER_INFOBARS_CRYPTO_WALLETS_INFOBAR_DELEGATE_H_
#define HUHI_BROWSER_INFOBARS_CRYPTO_WALLETS_INFOBAR_DELEGATE_H_
...
#endif  // HUHI_BROWSER_INFOBARS_CRYPTO_WALLETS_INFOBAR_DELEGATE_H_
