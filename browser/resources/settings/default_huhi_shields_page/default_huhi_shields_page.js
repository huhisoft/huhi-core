...
/**
 * 'settings-default-huhi-shields-page' is the settings page containing huhi's
 * default shields.
 */
Polymer({
  is: 'settings-default-huhi-shields-page',
  ...
  /** @private {?settings.DefaultHuhiShieldsBrowserProxy} */
  browserProxy_: null,

  /** @override */
  created: function() {
    this.browserProxy_ = settings.DefaultHuhiShieldsBrowserProxyImpl.getInstance();
  },
