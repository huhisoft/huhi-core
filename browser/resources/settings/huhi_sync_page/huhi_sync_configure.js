...
/**
 * @fileoverview
 * 'settings-huhi-sync-configure' is the set of controls which fetches, displays
 * and updates the sync configuration.
 */

import './huhi_sync_code_dialog.js';
...
Polymer({
  is: 'settings-huhi-sync-configure',
  ...
  /** @override */
  created: function() {
    this.browserProxy_ = HuhiSyncBrowserProxy.getInstance();
  },
  ...
  onResetSyncChain_: async function() {
    const messageText = this.i18n('huhiSyncResetConfirmation')
