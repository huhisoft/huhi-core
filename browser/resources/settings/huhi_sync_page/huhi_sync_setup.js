...
/**
 * @fileoverview
 * 'huhi-sync-setup' is the UI for starting or joining a sync chain
 * settings.
 */
...
Polymer({
  ...
  /** @private {?HuhiSyncBrowserProxy} */
  syncBrowserProxy_: null,

  created: function() {
    this.syncBrowserProxy_ = HuhiSyncBrowserProxy.getInstance();
  },
