...
import {RegisterStyleOverride, RegisterPolymerComponentBehaviors} from 'chrome://huhi-resources/polymer_overriding.js'

// TODO: move throttle utility to a chrome://huhi-resources module
  ...
  html`
    <style>
      :host {
        ...
        --huhi-settings-content-max-width: 708px;
        --huhi-settings-menu-width: var(--settings-menu-width);
        --huhi-settings-menu-margin: 12px;
      }
      cr-drawer {
      ...
      #left {
        /* fixed size menu */
        flex: 0 0 calc(var(--settings-menu-width) + var(--huhi-settings-menu-margin) * 2)  !important;
      }
      #main {
        /* Take up rest of container up to a max */
        flex: 0 1 var(--huhi-settings-content-max-width) !important;
      }
      #right {
...
const HuhiClearSettingsMenuHighlightBehavior = {
  ready: function() {
...
RegisterPolymerComponentBehaviors({
  'settings-ui': [
    HuhiClearSettingsMenuHighlightBehavior
  ]
})
