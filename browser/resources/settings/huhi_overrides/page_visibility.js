...
function getPageVisibility () {
  ...
  // which hides most sections, and add huhi sections to hide.
  if (loadTimeData.getBoolean('isGuest')) {
    // Hide appropriate huhi sections as well as chromium ones
    return {
  ...
  // would like to hide.
  // See huhi/browser/settings/huhi_overrides/basic_page.js for huhi's list,
  ...
  const staticProps = {
    ...
    // custom properties
    huhiSync: !loadTimeData.getBoolean('isSyncDisabled'),
  }
