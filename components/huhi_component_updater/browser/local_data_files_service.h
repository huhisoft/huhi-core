...
#ifndef HUHI_COMPONENTS_HUHI_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_SERVICE_H_
#define HUHI_COMPONENTS_HUHI_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_SERVICE_H_
...
const char kLocalDataFilesComponentName[] = "Huhi Local Data Updater";
...
class LocalDataFilesService : public HuhiComponent {
 public:
  explicit LocalDataFilesService(HuhiComponent::Delegate* delegate);
...
#endif  // HUHI_COMPONENTS_HUHI_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_SERVICE_H_
