...
#ifndef HUHI_COMPONENTS_HUHI_WAYBACK_MACHINE_WAYBACK_MACHINE_URL_FETCHER_H_
#define HUHI_COMPONENTS_HUHI_WAYBACK_MACHINE_WAYBACK_MACHINE_URL_FETCHER_H_
...
#endif  // HUHI_COMPONENTS_HUHI_WAYBACK_MACHINE_WAYBACK_MACHINE_URL_FETCHER_H_
