...
using HuhiWaybackMachineTest = InProcessBrowserTest;
using ::testing::_;
...
IN_PROC_BROWSER_TEST_F(HuhiWaybackMachineTest, InfobarAddTest) {
  auto* model = browser()->tab_strip_model();
  auto* contents = model->GetActiveWebContents();
  auto* tab_helper = HuhiWaybackMachineTabHelper::FromWebContents(contents);
