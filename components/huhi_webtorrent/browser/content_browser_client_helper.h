...
#ifndef HUHI_COMPONENTS_HUHI_WEBTORRENT_BROWSER_CONTENT_BROWSER_CLIENT_HELPER_H_
#define HUHI_COMPONENTS_HUHI_WEBTORRENT_BROWSER_CONTENT_BROWSER_CLIENT_HELPER_H_
...
static GURL TranslateMagnetURL(const GURL& url) {
  GURL extension_page_url(
      base::StrCat({extensions::kExtensionScheme, "://",
        ...
        "/extension/huhi_webtorrent.html?%s"}));
...
static bool HandleTorrentURLReverseRewrite(GURL* url,
  ...
  if (url->SchemeIs(extensions::kExtensionScheme) &&
      url->host() == huhi_webtorrent_extension_id &&
      url->ExtractFileName() == "huhi_webtorrent.html" &&
...
#endif  // HUHI_COMPONENTS_HUHI_WEBTORRENT_BROWSER_CONTENT_BROWSER_CLIENT_HELPER_H_
