 ...
 * for storing values in Redux and does not tell which huhi settings have changed.
 */
...
/**
 * Perform an update in settings both in huhi://settings and Shields store whenever a setting change.
...
/**
 * Get a list of settings values from huhi://settings and update if comparison
