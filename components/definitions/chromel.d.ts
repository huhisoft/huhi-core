...
declare namespace chrome.huhiRewards {
...
declare namespace chrome.huhiTogether {
  const isSupported: (callback: (supported: boolean) => void) => {}
}
...
declare namespace chrome.huhiToday {
...
declare namespace chrome.huhiShields {
  const onBlocked: {
  ...
  const setHuhiShieldsEnabledAsync: any
  const getHuhiShieldsEnabledAsync: any
  ...
  type HuhiShieldsViewPreferences = {
    showAdvancedView: boolean
    statsBadgeVisible: boolean
  }
}

declare namespace chrome.huhiWallet {
...
declare namespace chrome.huhiTheme {
  ...
  const getHuhiThemeType: (themeType: ThemeTypeCallback) => void
  const getHuhiThemeList: (themeList: ThemeListCallback) => void
  const setHuhiThemeType: (themeType: ThemeType) => void
  const onHuhiThemeTypeChanged: {
