...
#ifndef HUHI_COMPONENTS_P3A_HUHI_P3A_LOG_STORE_H_
#define HUHI_COMPONENTS_P3A_HUHI_P3A_LOG_STORE_H_
...
class HuhiP3ALogStore : public metrics::LogStore {
 public:
  class Delegate {
   public:
  ...
  explicit HuhiP3ALogStore(Delegate* delegate,
                            PrefService* local_state);

  // TODO(iefremov): Make parent destructor virtual?
  virtual ~HuhiP3ALogStore();
...
#endif  // HUHI_COMPONENTS_P3A_HUHI_P3A_LOG_STORE_H_
