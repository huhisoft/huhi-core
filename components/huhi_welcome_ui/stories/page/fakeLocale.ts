...
const locale = {
  // first screen
  welcome: 'Huhi the new Internet',
  whatIsHuhi: 'Get ready to enjoy a faster and more secure browsing experience with a browser built to protect your privacy.',
  letsGo: 'Let\'s go',
  // second screen
  ...
  // adjustProtectionLevel: 'Protect against privacy-invading ads and trackers while browsing with Huhi Shields. Set Shields to "down" if a site doesn’t seem to be working properly.',
  // showMeWhere: 'Show Shields',
  p3aHead: 'Browse safe and sound',
  p3aBody: 'Huhi Shields blocks the creepy stuff that tries to track you across the web — including most ads. Huhi uses completely private product analytics to estimate the overall usage of certain features. Turn this off in ',
  p3aSettings: 'Settings',
  p3aLink1: '#',
  p3aLink2: '#',
  // fifth screen
  enableHuhiRewards: 'Enable Huhi Rewards',
  setupHuhiRewards: 'Your attention is valuable. Earn by viewing privacy-respecting ads while you browse, and pay it forward to support content creators you love.',
