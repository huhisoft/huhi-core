...
#ifndef HUHI_COMPONENTS_HUHI_ADS_BROWSER_ADS_NOTIFICATION_HANDLER_H_
#define HUHI_COMPONENTS_HUHI_ADS_BROWSER_ADS_NOTIFICATION_HANDLER_H_
...
class AdsNotificationHandler : public NotificationHandler {
 public:
  ...
  void SetAdsService(huhi_ads::AdsServiceImpl* ads_service);
...
#endif  // HUHI_COMPONENTS_HUHI_ADS_BROWSER_ADS_NOTIFICATION_HANDLER_H_
