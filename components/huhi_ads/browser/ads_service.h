...
#ifndef HUHI_COMPONENTS_HUHI_ADS_BROWSER_ADS_SERVICE_H_
#define HUHI_COMPONENTS_HUHI_ADS_BROWSER_ADS_SERVICE_H_
...
#endif  // HUHI_COMPONENTS_HUHI_ADS_BROWSER_ADS_SERVICE_H_
