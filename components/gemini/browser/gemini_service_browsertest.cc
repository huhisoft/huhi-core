...
#include "huhi/browser/gemini/gemini_service_factory.h"
...
// npm run test -- huhi_browser_tests --filter=GeminiAPIBrowserTest.*
...
IN_PROC_BROWSER_TEST_F(GeminiAPIBrowserTest, GetOAuthClientURL) {
  ...
  GURL expected_url(
    ...
    "redirect_uri=com.huhi.gemini%3A%2F%2Fauthorization&"
