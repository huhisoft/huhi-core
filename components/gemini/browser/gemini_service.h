...
#ifndef HUHI_COMPONENTS_GEMINI_BROWSER_GEMINI_SERVICE_H_
#define HUHI_COMPONENTS_GEMINI_BROWSER_GEMINI_SERVICE_H_
...
#endif  // HUHI_COMPONENTS_GEMINI_BROWSER_GEMINI_SERVICE_H_
