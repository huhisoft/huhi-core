...
#ifndef HUHI_COMPONENTS_HUHI_PROCHLO_PROCHLO_DATA_H_
#define HUHI_COMPONENTS_HUHI_PROCHLO_PROCHLO_DATA_H_
...
#endif  //  HUHI_COMPONENTS_HUHI_PROCHLO_PROCHLO_DATA_H_
