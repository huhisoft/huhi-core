...
#ifndef HUHI_COMPONENTS_HUHI_PROCHLO_PROCHLO_CRYPTO_H_
#define HUHI_COMPONENTS_HUHI_PROCHLO_PROCHLO_CRYPTO_H_
...
class Crypto {
 ...
 private:
  friend class HuhiProchloCrypto;
...
#endif  // HUHI_COMPONENTS_HUHI_PROCHLO_PROCHLO_CRYPTO_H_
