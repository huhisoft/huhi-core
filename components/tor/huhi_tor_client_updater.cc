...
#include "huhi/components/tor/tor_switches.h"
...
HuhiTorClientUpdater::HuhiTorClientUpdater(
    HuhiComponent::Delegate* component_delegate,
    PrefService* local_state,
    const base::FilePath& user_data_dir)
    : HuhiComponent(component_delegate),
...
bool HuhiTorClientUpdater::IsTorDisabled() {
  if (local_state_)
