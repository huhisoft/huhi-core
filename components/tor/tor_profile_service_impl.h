...
#ifndef HUHI_COMPONENTS_TOR_TOR_PROFILE_SERVICE_IMPL_H_
#define HUHI_COMPONENTS_TOR_TOR_PROFILE_SERVICE_IMPL_H_
...
class TorProfileServiceImpl : public TorProfileService,
 ...
 public:
  TorProfileServiceImpl(content::BrowserContext* context,
                        HuhiTorClientUpdater* tor_client_updater,
 ...
 private:
  ...
  HuhiTorClientUpdater* tor_client_updater_ = nullptr;
...
#endif  // HUHI_COMPONENTS_TOR_TOR_PROFILE_SERVICE_IMPL_H_
