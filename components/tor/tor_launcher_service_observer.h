...
#ifndef HUHI_COMPONENTS_TOR_TOR_LAUNCHER_SERVICE_OBSERVER_H_
#define HUHI_COMPONENTS_TOR_TOR_LAUNCHER_SERVICE_OBSERVER_H_
...
#endif  // HUHI_COMPONENTS_TOR_TOR_LAUNCHER_SERVICE_OBSERVER_H_
