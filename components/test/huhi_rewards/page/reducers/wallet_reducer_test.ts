...
import reducers from '../../../../huhi_rewards/resources/page/reducers/index'
import * as actions from '../../../../huhi_rewards/resources/page/actions/rewards_actions'
import { types } from '../../../../huhi_rewards/resources/page/constants/rewards_types'
import { defaultState } from '../../../../huhi_rewards/resources/page/storage'
...
describe('wallet reducer', () => {
  ...
  describe('ON_RECOVER_WALLET_DATA', () => {
    ...
    it('recovered successfully', () => {
      ...
      expect(chromeSpy.mock.calls[0][0]).toEqual('huhi_rewards.getWalletPassphrase')
      expect(chromeSpy.mock.calls[1][0]).toEqual('huhi_rewards.fetchPromotions')
      expect(chromeSpy.mock.calls[2][0]).toEqual('huhi_rewards.fetchBalance')
      expect(chromeSpy.mock.calls[3][0]).toEqual('huhi_rewards.getBalanceReport')
