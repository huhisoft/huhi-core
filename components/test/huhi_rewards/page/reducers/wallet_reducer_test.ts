...
describe('wallet reducer', () => {
  ...
  describe('ON_RECOVER_WALLET_DATA', () => {
    ...
    it('recovered successfully', () => {
      ...
      expect(chromeSpy.mock.calls[0][0]).toEqual('huhi_rewards.fetchPromotions')
      expect(chromeSpy.mock.calls[1][0]).toEqual('huhi_rewards.fetchBalance')
      expect(chromeSpy.mock.calls[2][0]).toEqual('huhi_rewards.getPaymentId')
