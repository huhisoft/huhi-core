...
import ShieldsHeader, { Props } from '../../../../huhi_extension/extension/huhi_extension/containers/advancedView/header'
import { BlockOptions } from '../../../../huhi_extension/extension/huhi_extension/types/other/blockTypes'
import * as actionTypes from '../../../../huhi_extension/extension/huhi_extension/constants/shieldsPanelTypes'
...
describe('AdvancedView Header component', () => {
  ...
  it('renders the component', () => {
    ...
    const assertion = wrapper.find('#huhiShieldsHeader').length === 1
