...
import { SettingsMenu } from '../../../../components/huhi_new_tab_ui/components/default'
import Settings, { Props } from '../../../../components/huhi_new_tab_ui/containers/newTab/settings'
