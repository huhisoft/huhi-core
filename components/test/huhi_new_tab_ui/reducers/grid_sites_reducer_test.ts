...
import gridSitesReducer from '../../../huhi_new_tab_ui/reducers/grid_sites_reducer'
import * as storage from '../../../huhi_new_tab_ui/storage/grid_sites_storage'
import { types } from '../../../huhi_new_tab_ui/constants/grid_sites_types'
import * as gridSitesState from '../../../huhi_new_tab_ui/state/gridSitesState'
...
describe('gridSitesReducer', () => {
  ...
  describe('GRID_SITES_SET_FIRST_RENDER_DATA', () => {
    ...
    it('check gridSites does not have sites that are removed from topSites', () => {
      ...
      expect(assertion.gridSites[1].url).toBe('www.huhisoft.com')
    })
    it('check sites from SR are not deleted from gridSites', () => {
      ...
      expect(assertion.gridSites[2].url).toBe('www.huhisoft.com')
    })
