...
import { webtorrentReducer } from '../../../../huhi_webtorrent/extension/background/reducers/webtorrent_reducer'
import * as tabActions from '../../../../huhi_webtorrent/extension/actions/tab_actions'
import { torrentObjMap } from '../../testData'

// this import seems to trigger createStore and get an undefined reducer
jest.mock('../../../../huhi_webtorrent/extension/background/events/torrentEvents')
