...
import { types } from '../../../huhi_webtorrent/extension/constants/webtorrent_types'
import * as actions from '../../../huhi_webtorrent/extension/actions/webtorrent_actions'
...
const torrent: Torrent = {
  ...
  torrentFileBlobURL: 'https://huhisoft.com',
  files: [],
  received: 1337,
  path: '/',
  ready: true,
