...
AdBlockBaseService::AdBlockBaseService(HuhiComponent::Delegate* delegate)
    : BaseHuhiShieldsService(delegate),
...
void AdBlockBaseService::GetDATFileData(const base::FilePath& dat_file_path) {
  base::PostTaskAndReplyWithResult(
      ...
      base::BindOnce(&huhi_component_updater::LoadDATFileData<adblock::Engine>,
                     dat_file_path),
