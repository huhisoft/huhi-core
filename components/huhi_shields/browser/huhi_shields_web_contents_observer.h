...
#ifndef HUHI_COMPONENTS_HUHI_SHIELDS_BROWSER_HUHI_SHIELDS_WEB_CONTENTS_OBSERVER_H_
#define HUHI_COMPONENTS_HUHI_SHIELDS_BROWSER_HUHI_SHIELDS_WEB_CONTENTS_OBSERVER_H_
...
class HuhiShieldsWebContentsObserver : public content::WebContentsObserver,
    public content::WebContentsUserData<HuhiShieldsWebContentsObserver> {
 public:
  explicit HuhiShieldsWebContentsObserver(content::WebContents*);
  ~HuhiShieldsWebContentsObserver() override;
 ...
 private:
  friend class content::WebContentsUserData<HuhiShieldsWebContentsObserver>;
  ...
  DISALLOW_COPY_AND_ASSIGN(HuhiShieldsWebContentsObserver);
};

}  // namespace huhi_shields

#endif  // HUHI_COMPONENTS_HUHI_SHIELDS_BROWSER_HUHI_SHIELDS_WEB_CONTENTS_OBSERVER_H_
