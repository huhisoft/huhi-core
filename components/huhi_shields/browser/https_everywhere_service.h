...
#ifndef HUHI_COMPONENTS_HUHI_SHIELDS_BROWSER_HTTPS_EVERYWHERE_SERVICE_H_
#define HUHI_COMPONENTS_HUHI_SHIELDS_BROWSER_HTTPS_EVERYWHERE_SERVICE_H_
...
#include "huhi/components/huhi_shields/browser/https_everywhere_recently_used_cache.h"
...
class HTTPSEverywhereService : public BaseHuhiShieldsService,
                         public base::SupportsWeakPtr<HTTPSEverywhereService> {
 public:
  explicit HTTPSEverywhereService(HuhiComponent::Delegate* delegate);
...
#endif  // HUHI_COMPONENTS_HUHI_SHIELDS_BROWSER_HTTPS_EVERYWHERE_SERVICE_H_
