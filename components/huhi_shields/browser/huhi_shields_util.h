...
#ifndef HUHI_COMPONENTS_HUHI_SHIELDS_BROWSER_HUHI_SHIELDS_UTIL_H_
#define HUHI_COMPONENTS_HUHI_SHIELDS_BROWSER_HUHI_SHIELDS_UTIL_H_
...
void ResetHuhiShieldsEnabled(HostContentSettingsMap* map,
                              const GURL& url);
...
#endif  // HUHI_COMPONENTS_HUHI_SHIELDS_BROWSER_HUHI_SHIELDS_UTIL_H_
