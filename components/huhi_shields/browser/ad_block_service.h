...
#ifndef HUHI_COMPONENTS_HUHI_SHIELDS_BROWSER_AD_BLOCK_SERVICE_H_
#define HUHI_COMPONENTS_HUHI_SHIELDS_BROWSER_AD_BLOCK_SERVICE_H_
...
const char kAdBlockComponentName[] = "Huhi Ad Block Updater";
...
// The huhi shields service in charge of ad-block checking and init.
class AdBlockService : public AdBlockBaseService {
 public:
  explicit AdBlockService(HuhiComponent::Delegate* delegate);
 ...
 private:
  ...
  std::unique_ptr<huhi_shields::AdBlockRegionalServiceManager>
      regional_service_manager_;
  std::unique_ptr<huhi_shields::AdBlockCustomFiltersService>
      custom_filters_service_;

  HuhiComponent::Delegate* component_delegate_;
...
#endif  // HUHI_COMPONENTS_HUHI_SHIELDS_BROWSER_AD_BLOCK_SERVICE_H_
