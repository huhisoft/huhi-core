...
#ifndef HUHI_COMPONENTS_HUHI_SHIELDS_COMMON_HUHI_SHIELD_CONSTANTS_H_
#define HUHI_COMPONENTS_HUHI_SHIELDS_COMMON_HUHI_SHIELD_CONSTANTS_H_
...
const char kHuhiShields[] = "huhiShields";
...
#endif  // HUHI_COMPONENTS_HUHI_SHIELDS_COMMON_HUHI_SHIELD_CONSTANTS_H_
