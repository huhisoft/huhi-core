...
// npm run test -- huhi_browser_tests --filter=RewardsPublisherBrowserTest.*
...
// Huhi tip icon is injected when visiting Twitter
IN_PROC_BROWSER_TEST_F(
    RewardsPublisherBrowserTest,
...
// Huhi tip icon is not injected when visiting Twitter while Huhi
// Rewards is disabled
IN_PROC_BROWSER_TEST_F(
    RewardsPublisherBrowserTest,
...
// Huhi tip icon is injected when visiting old Twitter
IN_PROC_BROWSER_TEST_F(
    RewardsPublisherBrowserTest,
...
// Huhi tip icon is not injected when visiting old Twitter while
// Huhi Rewards is disabled
IN_PROC_BROWSER_TEST_F(
    RewardsPublisherBrowserTest,
...
// Huhi tip icon is not injected into non-Twitter sites
IN_PROC_BROWSER_TEST_F(
    RewardsPublisherBrowserTest,
...
// Huhi tip icon is injected when visiting Reddit
IN_PROC_BROWSER_TEST_F(
    RewardsPublisherBrowserTest,
...
// Huhi tip icon is not injected when visiting Reddit
IN_PROC_BROWSER_TEST_F(
    RewardsPublisherBrowserTest,
...
// Huhi tip icon is injected when visiting GitHub
IN_PROC_BROWSER_TEST_F(
    RewardsPublisherBrowserTest,
...
// Huhi tip icon is not injected when visiting GitHub while Huhi
// Rewards is disabled
IN_PROC_BROWSER_TEST_F(
    RewardsPublisherBrowserTest,
...
// Huhi tip icon is not injected when not visiting GitHub
IN_PROC_BROWSER_TEST_F(
    RewardsPublisherBrowserTest,
