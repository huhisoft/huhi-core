...
// npm run test -- huhi_browser_tests --filter=RewardsNotificationBrowserTest.*
...
class RewardsNotificationBrowserTest
 ...
 public:
  ...
  huhi_rewards::RewardsNotificationService* rewards_notification_service_;
...
IN_PROC_BROWSER_TEST_F(
  ...
  huhi_rewards::RewardsNotificationService::RewardsNotificationArgs args;
  args.push_back("foo");
  args.push_back("bar");
...
IN_PROC_BROWSER_TEST_F(
  ...
  EXPECT_TRUE(
      ...
      huhi_rewards::RewardsNotificationService::REWARDS_NOTIFICATION_INVALID);
}
