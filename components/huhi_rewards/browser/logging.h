...
#ifndef HUHI_COMPONENTS_HUHI_REWARDS_BROWSER_LOGGING_H_
#define HUHI_COMPONENTS_HUHI_REWARDS_BROWSER_LOGGING_H_
...
#endif  // HUHI_COMPONENTS_HUHI_REWARDS_BROWSER_LOGGING_H_
