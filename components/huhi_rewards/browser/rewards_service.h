...
#ifndef HUHI_COMPONENTS_HUHI_REWARDS_BROWSER_REWARDS_SERVICE_H_
#define HUHI_COMPONENTS_HUHI_REWARDS_BROWSER_REWARDS_SERVICE_H_
...
using GetHuhiWalletCallback =
    base::OnceCallback<void(ledger::type::HuhiWalletPtr wallet)>;
...
#endif  // HUHI_COMPONENTS_HUHI_REWARDS_BROWSER_REWARDS_SERVICE_H_
