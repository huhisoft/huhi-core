...
void RecordWalletBalanceP3A(bool wallet_created, bool rewards_enabled,
  ...
  UMA_HISTOGRAM_EXACT_LINEAR("Huhi.Rewards.WalletBalance.2", answer, 4);
}
...
void RecordAutoContributionsState(AutoContributionsP3AState state, int count) {
  ...
  UMA_HISTOGRAM_EXACT_LINEAR("Huhi.Rewards.AutoContributionsState.2", answer,
                             5);
}
...
void RecordTipsState(bool wallet_created,
  ...
  UMA_HISTOGRAM_EXACT_LINEAR("Huhi.Rewards.TipsState.2", answer, 5);
}

void RecordAdsState(AdsP3AState state) {
  UMA_HISTOGRAM_ENUMERATION("Huhi.Rewards.AdsState.2", state);
}
