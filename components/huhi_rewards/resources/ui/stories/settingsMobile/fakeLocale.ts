...
const locale = {
  adsDesc: 'Earn tokens by seeing ads on Huhi. Ads are matched from machine learning and the data temporarily present in your browser without tracking your information or sending it outside.',
  ...
  contributionTitle: 'Huhi Contribute',
  ...
  rewardsDisabledDescTwo: 'Today, Huhi welcomes you to the new internet. One where your time is valued, your personal data is kept private, and you actually get paid for your attention.',
