...
import { Select, ControlWrapper, Modal } from 'huhi-ui/components'
import { PrintIcon } from 'huhi-ui/components/icons'
...
export default class ModalActivity extends React.PureComponent<Props, State> {
  ...
  get modalTitle () {
    return (
      <StyledTitle>
        {getLocale('huhiRewards')} <StyledSubTitle>{getLocale('walletActivity')}</StyledSubTitle>
      </StyledTitle>
    )
  }
