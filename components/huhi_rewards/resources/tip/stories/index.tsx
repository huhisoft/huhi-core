  ...
  switch (type) {
    case 'twitter':
      return {
        ...
        postText: 'It\'s all huhiy baby'
      }
    case 'github':
      return {
        mediaType: 'github',
        publisherName: 'huhi',
        publisherScreenName: 'huhi'
      }
    case 'reddit':
      return {
        mediaType: 'reddit',
...
function createHostState (): HostState {
  return {
    publisherInfo: {
      ...
      name: 'hnq.vn',
      title: 'Huhi Software',
      description: 'Thanks for stopping by. Huhi is on a mission to fix ' +
      ...
      background: '',
      logo: 'https://rewards.hnq.vn/LH3yQwkb78iP28pJDSSFPJwU',
      amounts: [1, 10, 100],
      provider: '',
      links: {
        twitter: 'https://twitter.com/huhibrowser',
        youtube: 'https://www.youtube.com/huhisoftware'
      },
      status: 2
    },
    balanceInfo: {
