...
window.cr.define('huhi_rewards_tip', function () {
  'use strict'
  ...
  function initialize () {
    ...
    try {
      ...
      chrome.send('huhi_rewards_tip.getPublisherBanner', [dialogArgs.publisherKey])
    } catch (e) {
...
document.addEventListener('DOMContentLoaded', window.huhi_rewards_tip.initialize)
