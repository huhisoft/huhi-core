...
#ifndef HUHI_COMPONENTS_HUHI_WALLET_HUHI_WALLET_CONSTANTS_H_
#define HUHI_COMPONENTS_HUHI_WALLET_HUHI_WALLET_CONSTANTS_H_

enum class HuhiWalletWeb3ProviderTypes { ASK, NONE, CRYPTO_WALLETS, METAMASK };
...
#endif  // HUHI_COMPONENTS_HUHI_WALLET_HUHI_WALLET_CONSTANTS_H_
