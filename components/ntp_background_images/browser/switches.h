...
#ifndef HUHI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_SWITCHES_H_
#define HUHI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_SWITCHES_H_
...
#endif  // HUHI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_SWITCHES_H_
