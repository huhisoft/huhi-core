...
constexpr char kNewTabsCreated[] = "huhi.new_tab_page.p3a_new_tabs_created";
constexpr char kSponsoredNewTabsCreated[] =
    "huhi.new_tab_page.p3a_sponsored_new_tabs_created";
...
void ViewCounterService::BrandedWallpaperWillBeDisplayed(
  ...
  ads_service_->OnNewTabPageAdEvent(wallpaper_id, creative_instance_id,
      ads::mojom::HuhiAdsNewTabPageAdEventType::kViewed);
...
void ViewCounterService::BrandedWallpaperLogoClicked(
  ...
  ads_service_->OnNewTabPageAdEvent(wallpaper_id, creative_instance_id,
      ads::mojom::HuhiAdsNewTabPageAdEventType::kClicked);
}
...
void ViewCounterService::UpdateP3AValues() const {
  ...
  UMA_HISTOGRAM_EXACT_LINEAR("Huhi.NTP.NewTabsCreated", answer,
  ...
  UMA_HISTOGRAM_EXACT_LINEAR("Huhi.NTP.SponsoredNewTabsCreated", answer,
