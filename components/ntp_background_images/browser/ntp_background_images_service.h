...
#ifndef HUHI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_BACKGROUND_IMAGES_SERVICE_H_
#define HUHI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_BACKGROUND_IMAGES_SERVICE_H_
...
class NTPBackgroundImagesService {
 ...
 private:
  ...
  // not show SI images until user chooses Huhi default images. So, we should
...
#endif  // HUHI_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_BACKGROUND_IMAGES_SERVICE_H_
