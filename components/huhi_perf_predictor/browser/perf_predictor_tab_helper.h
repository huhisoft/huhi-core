...
#ifndef HUHI_COMPONENTS_HUHI_PERF_PREDICTOR_BROWSER_PERF_PREDICTOR_TAB_HELPER_H_
#define HUHI_COMPONENTS_HUHI_PERF_PREDICTOR_BROWSER_PERF_PREDICTOR_TAB_HELPER_H_

#include <memory>
#include <string>

#include "huhi/components/huhi_perf_predictor/browser/bandwidth_savings_predictor.h"
...
#endif  // HUHI_COMPONENTS_HUHI_PERF_PREDICTOR_BROWSER_PERF_PREDICTOR_TAB_HELPER_H_
