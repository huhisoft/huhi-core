...
#ifndef HUHI_COMPONENTS_HUHI_REFERRALS_BROWSER_HUHI_REFERRALS_SERVICE_H_
#define HUHI_COMPONENTS_HUHI_REFERRALS_BROWSER_HUHI_REFERRALS_SERVICE_H_
...
#include "huhi/components/safetynet/safetynet_check.h"
#endif
...
class HuhiReferralsService {
 public:
  explicit HuhiReferralsService(PrefService* pref_service,
                                 const std::string& platform,
                                 const std::string& api_key);
  ~HuhiReferralsService();
 ...
 private:
  ...
  base::WeakPtrFactory<HuhiReferralsService> weak_factory_;
};

// Registers the preferences used by HuhiReferralsService
void RegisterPrefsForHuhiReferralsService(PrefRegistrySimple* registry);

}  // namespace huhi

#endif  // HUHI_COMPONENTS_HUHI_REFERRALS_BROWSER_HUHI_REFERRALS_SERVICE_H_
