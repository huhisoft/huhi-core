...
#ifndef HUHI_COMPONENTS_OMNIBOX_BROWSER_TOPSITES_PROVIDER_H_
#define HUHI_COMPONENTS_OMNIBOX_BROWSER_TOPSITES_PROVIDER_H_
...
#endif  // HUHI_COMPONENTS_OMNIBOX_BROWSER_TOPSITES_PROVIDER_H_
