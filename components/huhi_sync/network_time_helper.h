...
#ifndef HUHI_COMPONENTS_HUHI_SYNC_NETWORK_TIME_HELPER_H_
#define HUHI_COMPONENTS_HUHI_SYNC_NETWORK_TIME_HELPER_H_
...
#endif  // HUHI_COMPONENTS_HUHI_SYNC_NETWORK_TIME_HELPER_H_
