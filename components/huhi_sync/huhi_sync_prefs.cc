...
const char kSyncV2Seed[] = "huhi_sync_v2.seed";
// Indicate whether migration has been done from v1 to v2
const char kSyncV1Migrated[] = "huhi_sync_v2.v1_migrated";
// Indicate all meta info set in V1 has been stripped in
// HuhiBookmarkModelLoadedObserver
const char kSyncV1MetaInfoCleared[] = "huhi_sync_v2.v1_meta_info_cleared";
// Has dismissed message about migration to sync v2
const char kSyncV2MigrateNoticeDismissed[] =
    "huhi_sync_v2.migrate_notice_dismissed";
// Deprecated
// ============================================================================
const char kSyncSeed[] = "huhi_sync.seed";
const char kSyncEnabled[] = "huhi_sync.enabled";
const char kSyncDeviceId[] = "huhi_sync.device_id";
const char kSyncDeviceIdV2[] = "huhi_sync.device_id_v2";
const char kSyncDeviceObjectId[] = "huhi_sync.device_object_id";
const char kSyncPrevSeed[] = "huhi_sync.previous_seed";
const char kSyncDeviceName[] = "huhi_sync.device_name";
const char kSyncBookmarksBaseOrder[] = "huhi_sync.bookmarks_base_order";
const char kSyncBookmarksEnabled[] = "huhi_sync.bookmarks_enabled";
const char kSyncSiteSettingsEnabled[] = "huhi_sync.site_settings_enabled";
const char kSyncHistoryEnabled[] = "huhi_sync.history_enabled";
const char kSyncLatestRecordTime[] = "huhi_sync.latest_record_time";
const char kSyncLatestDeviceRecordTime[] =
    "huhi_sync.latest_device_record_time";
const char kSyncLastFetchTime[] = "huhi_sync.last_fetch_time";
const char kSyncLastCompactTimeBookmarks[] =
    "huhi_sync.last_compact_time.bookmarks";
const char kSyncDeviceList[] = "huhi_sync.device_list";
const char kSyncApiVersion[] = "huhi_sync.api_version";
const char kSyncMigrateBookmarksVersion[]
                                       = "huhi_sync.migrate_bookmarks_version";
const char kSyncRecordsToResend[] = "huhi_sync_records_to_resend";
const char kSyncRecordsToResendMeta[] = "huhi_sync_records_to_resend_meta";
const char kDuplicatedBookmarksRecovered[] =
    "huhi_sync_duplicated_bookmarks_recovered";
const char kDuplicatedBookmarksMigrateVersion[] =
    "huhi_sync_duplicated_bookmarks_migrate_version";
// ============================================================================
}  // namespace
