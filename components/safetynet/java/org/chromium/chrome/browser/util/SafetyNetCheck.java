...
public class SafetyNetCheck {
    ...
    */
    ...
    private boolean clientAttestation(String nonceData, String apiKey,
        ...
        boolean res = false;
        try {
            Activity activity = (Activity)HuhiRewardsHelper.getChromeTabbedActivity();
        ...
        if (performAttestationOnClient) {
            if (tokenReceived) {
                ...
                if (tokenParts.length >= 2) {
                    ...
                    HuhiPrefServiceBridge.getInstance().setSafetynetStatus(attestationPassed
                ...
                HuhiPrefServiceBridge.getInstance().setSafetynetStatus(
