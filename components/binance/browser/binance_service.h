...
#ifndef HUHI_COMPONENTS_BINANCE_BROWSER_BINANCE_SERVICE_H_
#define HUHI_COMPONENTS_BINANCE_BROWSER_BINANCE_SERVICE_H_
...
#endif  // HUHI_COMPONENTS_BINANCE_BROWSER_BINANCE_SERVICE_H_
