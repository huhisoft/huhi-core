...
public class HuhiSiteSettingsPreferencesBase extends SiteSettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SettingsUtils.addPreferencesFromResource(this, R.xml.huhi_site_settings_preferences);
        configureHuhiPreferences();
        updateHuhiPreferenceStates();
    }
