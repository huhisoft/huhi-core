...
// import { getUnpaddedAsDataUrl } from '../../huhi_extension/extension/huhi_extension/background/today/privateCDN'
...
// @ts-ignore
window.huhiStorybookUnpadUrl = async function UnpadUrl (paddedUrl: string, mimeType = 'image/jpg'): Promise<string> {
