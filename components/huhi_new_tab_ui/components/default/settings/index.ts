...
import styled, { css } from 'huhi-ui/theme'
...
export const SettingsSidebarActiveButtonSlider =
  ...
  height: 48px;
  width: 4px;
  background: linear-gradient(93.83deg, ${p => p.theme.color.brandHuhi} -3.53%, ${p => p.theme.palette.magenta500} 110.11%);
...
export const SettingsSidebarButtonText = styled<{ isActive: boolean }, 'span'>('span')`
  ...
  &:hover {
    color: ${p => p.theme.color.brandHuhi};
  }
  ...
  &:after {
    ...
    background-image: linear-gradient(93.83deg, ${p => p.theme.color.brandHuhi} -3.53%, ${p => p.theme.palette.magenta500} 110.11%);
    overflow: hidden;
    text-overflow: ellipsis;
    transition: opacity var(--sidebar-button-transition-timing) ease-in-out,
                font-weight var(--sidebar-button-transition-timing) ease-in-out;
...
export const SettingsSidebarButton = styled<SettingsSidebarButtonProps, 'button'>('button')`
  ...
  &:hover {
    ${SettingsSidebarSVGContent} {
      background: ${p => p.theme.color.brandHuhi};
    }
  ...
  &:focus-visible {
    outline-style: solid;
    outline-color: ${p => p.theme.color.brandHuhi};
    outline-width: 1px;
  }
`
...
export const SettingsCloseIcon = styled<{}, 'button'>('button')`
  ...
  &:active {
    color: ${p => p.theme.color.brandHuhiActive};
  }
...
export const SettingsRow = styled<SettingsRowProps, 'div'>('div')`
  ...
  ${p => p.isInteractive && css`
    cursor: pointer;
    &:focus-visible {
      outline: solid 1px ${p => p.theme.color.brandHuhi};
    }
    &:hover {
      color: ${p => p.theme.color.brandHuhiInteracting}
    }
    &:active {
      color: ${p => p.theme.color.brandHuhiActive}
    }
