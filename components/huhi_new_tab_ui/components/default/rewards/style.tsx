...
import palette from 'huhi-ui/theme/colors'
...
import TOSAndPP, { Props as TOSProps } from '../../../../huhi_rewards/resources/ui/components/TOSAndPP'
...
export const TurnOnButton = styled<{}, 'button'>('button')`
  ...
  :focus {
    outline: none;
    box-shadow: 0 0 0 1px ${p => p.theme.color.brandHuhi};
  }
`
