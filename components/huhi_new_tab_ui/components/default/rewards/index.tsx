...
import { convertBalance } from '../../../../huhi_rewards/resources/page/utils'
...
import { BatColorIcon, CloseStrokeIcon } from 'huhi-ui/components/icons'
    ...
    return (
      <>
        ...
        <PreOptInAction>
          ...
          <LearnMoreTextButton href='https://www.huhisoft.com/huhi-rewards'>
  ...
  renderTitle = () => {
    ...
    return (
      <RewardsTitle isInTab={!showContent}>
        ...
        {getLocale('rewardsWidgetHuhiRewards')}
      </RewardsTitle>
    )
  }
