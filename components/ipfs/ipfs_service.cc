...
#include "huhi/components/ipfs/ipfs_json_parser.h"
#include "huhi/components/ipfs/ipfs_service_observer.h"
...
base::FilePath IpfsService::GetDataPath() const {
  return user_data_dir_.Append(FILE_PATH_LITERAL("huhi_ipfs"));
}
