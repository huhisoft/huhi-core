...
#ifndef HUHI_COMPONENTS_IPFS_HUHI_IPFS_CLIENT_UPDATER_H_
#define HUHI_COMPONENTS_IPFS_HUHI_IPFS_CLIENT_UPDATER_H_
...
#endif  // HUHI_COMPONENTS_IPFS_HUHI_IPFS_CLIENT_UPDATER_H_
