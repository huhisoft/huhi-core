...
#ifndef HUHI_COMPONENTS_IPFS_IPFS_SERVICE_OBSERVER_H_
#define HUHI_COMPONENTS_IPFS_IPFS_SERVICE_OBSERVER_H_
...
#endif  // HUHI_COMPONENTS_IPFS_IPFS_SERVICE_OBSERVER_H_
