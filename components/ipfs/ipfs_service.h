...
#ifndef HUHI_COMPONENTS_IPFS_IPFS_SERVICE_H_
#define HUHI_COMPONENTS_IPFS_IPFS_SERVICE_H_
...
class IpfsService : public KeyedService,
                    public HuhiIpfsClientUpdater::Observer {
 public:
 ...
 private:
  ...
  // HuhiIpfsClientUpdater::Observer
  ...
  HuhiIpfsClientUpdater* ipfs_client_updater_;
...
#endif  // HUHI_COMPONENTS_IPFS_IPFS_SERVICE_H_
