...
#ifndef HUHI_COMPONENTS_IPFS_IPFS_NAVIGATION_THROTTLE_H_
#define HUHI_COMPONENTS_IPFS_IPFS_NAVIGATION_THROTTLE_H_
...
#endif  // HUHI_COMPONENTS_IPFS_IPFS_NAVIGATION_THROTTLE_H_
