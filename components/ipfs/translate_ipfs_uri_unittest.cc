...
TEST_F(IPFSHuhiContentBrowserClientTest, TranslateIPFSURINotIPFSScheme) {
...
TEST_F(IPFSHuhiContentBrowserClientTest, TranslateIPFSURIIPFSScheme) {
...
TEST_F(IPFSHuhiContentBrowserClientTest, TranslateIPFSURIIPNSScheme) {
...
TEST_F(IPFSHuhiContentBrowserClientTest, TranslateIPFSURIIPFSSchemeLocal) {
  GURL url("ipfs://QmfM2r8seH2GiRaC4esTjeraXEachRt8ZsSeGaWTPLyMoG");
  GURL new_url;
...
TEST_F(IPFSHuhiContentBrowserClientTest, TranslateIPFSURIIPNSSchemeLocal) {
  GURL url("ipns://QmSrPmbaUKA3ZodhzPWZnpFgcPMFWF4QsxXbkWfEptTBJd");
  GURL new_url;
  ASSERT_TRUE(ipfs::TranslateIPFSURI(url, &new_url, true));
...
TEST_F(IPFSHuhiContentBrowserClientTest, TranslateIPFSURIIPFSSchemeWithPath) {
  GURL url(
