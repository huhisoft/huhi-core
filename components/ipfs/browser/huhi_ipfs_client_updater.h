...
#ifndef HUHI_COMPONENTS_IPFS_BROWSER_HUHI_IPFS_CLIENT_UPDATER_H_
#define HUHI_COMPONENTS_IPFS_BROWSER_HUHI_IPFS_CLIENT_UPDATER_H_
...
class HuhiIpfsClientUpdaterTest;
...
static const char kIpfsClientComponentName[] =
    "Huhi Ipfs Client Updater (Windows)";
...
static const char kIpfsClientComponentName[] =
    "Huhi Ipfs Client Updater (Linux)";
static const char kIpfsClientComponentId[] =
...
class HuhiIpfsClientUpdater : public HuhiComponent {
 public:
  ...
  explicit HuhiIpfsClientUpdater(HuhiComponent::Delegate* delegate);
  ~HuhiIpfsClientUpdater() override;
 ...
 private:
  friend class ::HuhiIpfsClientUpdaterTest;
  ...
  base::WeakPtrFactory<HuhiIpfsClientUpdater> weak_ptr_factory_;

  DISALLOW_COPY_AND_ASSIGN(HuhiIpfsClientUpdater);
};

// Creates the HuhiIpfsClientUpdater
std::unique_ptr<HuhiIpfsClientUpdater>
HuhiIpfsClientUpdaterFactory(HuhiComponent::Delegate* delegate);

}  // namespace ipfs

#endif  // HUHI_COMPONENTS_IPFS_BROWSER_HUHI_IPFS_CLIENT_UPDATER_H_
