...
const char kIPFSAutoFallbackToGateway[] = "huhi.ipfs.auto_fallback_to_gateway";

// The number of times the infobar is shown to ask the user to install IPFS
const char kIPFSInfobarCount[] = "huhi.ipfs.infobar_count";

// A local state pref used to enable/disable IPFS via admin policy.
const char kIPFSEnabled[] = "huhi.ipfs.enabled";
