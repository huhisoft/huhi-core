...
void RecordIPFSCompanionInstalled(content::BrowserContext* context) {
  ...
  UMA_HISTOGRAM_BOOLEAN("Huhi.IPFS.IPFSCompanionInstalled", installed);
}
...
void RecordIPFSDetectionPromptCount(PrefService* prefs) {
  ...
  UMA_HISTOGRAM_EXACT_LINEAR("Huhi.IPFS.DetectionPromptCount", bucket,
                             max_bucket);
}
