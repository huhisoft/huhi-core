...
#ifndef HUHI_COMPONENTS_IPFS_IPFS_NOT_CONNECTED_PAGE_H_
#define HUHI_COMPONENTS_IPFS_IPFS_NOT_CONNECTED_PAGE_H_
...
#endif  // HUHI_COMPONENTS_IPFS_IPFS_NOT_CONNECTED_PAGE_H_
