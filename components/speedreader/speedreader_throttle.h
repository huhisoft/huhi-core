...
#ifndef HUHI_COMPONENTS_SPEEDREADER_SPEEDREADER_THROTTLE_H_
#define HUHI_COMPONENTS_SPEEDREADER_SPEEDREADER_THROTTLE_H_
...
#endif  // HUHI_COMPONENTS_SPEEDREADER_SPEEDREADER_THROTTLE_H_
