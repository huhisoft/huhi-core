...
#ifndef HUHI_COMPONENTS_SPEEDREADER_SPEEDREADER_SERVICE_H_
#define HUHI_COMPONENTS_SPEEDREADER_SPEEDREADER_SERVICE_H_
...
#endif  // HUHI_COMPONENTS_SPEEDREADER_SPEEDREADER_SERVICE_H_
