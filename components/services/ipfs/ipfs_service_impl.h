...
#ifndef HUHI_COMPONENTS_SERVICES_IPFS_IPFS_SERVICE_IMPL_H_
#define HUHI_COMPONENTS_SERVICES_IPFS_IPFS_SERVICE_IMPL_H_
...
#endif  // HUHI_COMPONENTS_SERVICES_IPFS_IPFS_SERVICE_IMPL_H_
