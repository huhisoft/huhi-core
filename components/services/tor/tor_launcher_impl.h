...
#ifndef HUHI_COMPONENTS_SERVICES_TOR_TOR_LAUNCHER_IMPL_H_
#define HUHI_COMPONENTS_SERVICES_TOR_TOR_LAUNCHER_IMPL_H_
...
#endif  // HUHI_COMPONENTS_SERVICES_TOR_TOR_LAUNCHER_IMPL_H_
