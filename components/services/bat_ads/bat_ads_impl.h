...
#ifndef HUHI_COMPONENTS_SERVICES_BAT_ADS_BAT_ADS_IMPL_H_
#define HUHI_COMPONENTS_SERVICES_BAT_ADS_BAT_ADS_IMPL_H_
...
#endif  // HUHI_COMPONENTS_SERVICES_BAT_ADS_BAT_ADS_IMPL_H_
