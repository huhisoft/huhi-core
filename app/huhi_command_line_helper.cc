...
HuhiCommandLineHelper::HuhiCommandLineHelper(base::CommandLine* command_line)
    : command_line_(*command_line) {
  Parse();
}

const std::unordered_set<std::string>&
HuhiCommandLineHelper::enabled_features() const {
  return enabled_features_;
}

const std::unordered_set<std::string>&
HuhiCommandLineHelper::disabled_features() const {
  return disabled_features_;
}

void HuhiCommandLineHelper::ParseCSV(
...
void HuhiCommandLineHelper::Parse() {
...
void HuhiCommandLineHelper::AppendSwitch(const char* switch_key) {
  if (!command_line_.HasSwitch(switch_key))
    command_line_.AppendSwitch(switch_key);
}

void HuhiCommandLineHelper::AppendFeatures(
...
void HuhiCommandLineHelper::AppendCSV(
...
void HuhiCommandLineHelper::AppendSwitchASCII(const char* switch_key,
                                               const char* value) {
  if (!command_line_.HasSwitch(switch_key))
