...
TEST(HuhiCommandLineHelperUnitTest, TestAppendSwitch) {
  base::CommandLine& command_line = *base::CommandLine::ForCurrentProcess();
  HuhiCommandLineHelper helper(&command_line);
...
TEST(HuhiCommandLineHelperUnitTest, TestParseFeatures) {
  base::CommandLine& command_line = *base::CommandLine::ForCurrentProcess();
...
TEST(HuhiCommandLineHelperUnitTest, TestAppendFeatures) {
  base::CommandLine& command_line = *base::CommandLine::ForCurrentProcess();
  HuhiCommandLineHelper helper(&command_line);
