...
#ifndef HUHI_APP_HUHI_COMMAND_LINE_HELPER_H_
#define HUHI_APP_HUHI_COMMAND_LINE_HELPER_H_
...
class HuhiCommandLineHelper {
 public:
  explicit HuhiCommandLineHelper(base::CommandLine* command_line);
  inline ~HuhiCommandLineHelper() = default;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(HuhiCommandLineHelper);
};

#endif  // HUHI_APP_HUHI_COMMAND_LINE_HELPER_H_
