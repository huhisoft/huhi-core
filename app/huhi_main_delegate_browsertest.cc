...
using HuhiMainDelegateBrowserTest = InProcessBrowserTest;
...
IN_PROC_BROWSER_TEST_F(HuhiMainDelegateBrowserTest,
...
IN_PROC_BROWSER_TEST_F(HuhiMainDelegateBrowserTest, DisableHyperlinkAuditing) {
  EXPECT_TRUE(
...
IN_PROC_BROWSER_TEST_F(HuhiMainDelegateBrowserTest, OriginTrialsTest) {
  EXPECT_TRUE(base::CommandLine::ForCurrentProcess()->HasSwitch(
      embedder_support::kOriginTrialPublicKey));
  EXPECT_EQ(kHuhiOriginTrialsPublicKey,
            base::CommandLine::ForCurrentProcess()->GetSwitchValueASCII(
                embedder_support::kOriginTrialPublicKey));
}

IN_PROC_BROWSER_TEST_F(HuhiMainDelegateBrowserTest, DisabledFeatures) {
...
IN_PROC_BROWSER_TEST_F(HuhiMainDelegateBrowserTest, EnabledFeatures) {
