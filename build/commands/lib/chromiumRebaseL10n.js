...
const {rebaseHuhiStringFilesOnChromiumL10nFiles, huhiAutoGeneratedPaths, logRemovedGRDParts} = require('./l10nUtil')
...
const chromiumRebaseL10n = async (options) => {
  ...
  const removed = await rebaseHuhiStringFilesOnChromiumL10nFiles()
  huhiAutoGeneratedPaths.forEach((sourceStringPath) => {
