...
program
  ...
  .option('--huhi_google_api_key <huhi_google_api_key>')
  .option('--huhi_google_api_endpoint <huhi_google_api_endpoint>')
  .option('--huhi_infura_project_id <huhi_infura_project_id>')
  ...
  .option('--huhi_safetynet_api_key <huhi_safetynet_api_key>')
...
program
  ...
  .option('--skip_signing', 'skip signing dmg/huhi_installer.exe')
...
program
  ...
  .option('--disable_huhi_extension', 'disable loading the Huhi extension')
  .option('--disable_huhi_rewards_extension', 'disable loading the Huhi Rewards extension')
  ...
  .option('--enable_huhi_update', 'enable huhi update')
  ...
  // See https://github.com/huhisoft/huhi-browser/wiki/Rewards#flags for more information
  .option('--rewards [options]', 'options for rewards')
  .option('--huhi_ads_testing', 'ads testing')
  .option('--huhi_ads_production', 'ads production')
  .option('--huhi_ads_staging', 'ads staging')
  .option('--huhi_ads_debug', 'ads debug')
  .option('--single_process', 'use a single process')
  .option('--network_log', 'log network activity to network_log.json')
  .option('--output_path [pathname]', 'use the Huhi binary located at [pathname]')
  .arguments('[build_config]')
  .action(start.bind(null, parsedArgs.unknown))

program
  .command('pull_l10n')
  .option('--extension <extension>', 'Scope this command to localize a Huhi extension such as ethereum-remote-client')
