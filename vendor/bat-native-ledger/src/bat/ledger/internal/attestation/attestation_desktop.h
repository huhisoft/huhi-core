...
#ifndef HUHILEDGER_ATTESTATION_ATTESTATION_DESKTOP_H_
#define HUHILEDGER_ATTESTATION_ATTESTATION_DESKTOP_H_
...
#endif  // HUHILEDGER_ATTESTATION_ATTESTATION_DESKTOP_H_
