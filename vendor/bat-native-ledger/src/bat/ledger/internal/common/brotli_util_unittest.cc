...
// npm run test -- huhi_unit_tests --filter='HuhiLedgerBrotliHelpersTest.*'
...
class HuhiLedgerBrotliHelpersTest : public testing::Test {
 protected:
...
TEST_F(HuhiLedgerBrotliHelpersTest, TestDecode) {
  std::string s;
...
TEST_F(HuhiLedgerBrotliHelpersTest, TestDecodeWithBuffer) {
  std::string s;
