...
#ifndef HUHILEDGER_DATABASE_DATABASE_SERVER_PUBLISHER_LINKS_H_
#define HUHILEDGER_DATABASE_DATABASE_SERVER_PUBLISHER_LINKS_H_
...
#endif  // HUHILEDGER_DATABASE_DATABASE_SERVER_PUBLISHER_LINKS_H_
