...
#ifndef HUHILEDGER_DATABASE_DATABASE_PENDING_CONTRIBUTION_H_
#define HUHILEDGER_DATABASE_DATABASE_PENDING_CONTRIBUTION_H_
...
#endif  // HUHILEDGER_DATABASE_DATABASE_PENDING_CONTRIBUTION_H_
