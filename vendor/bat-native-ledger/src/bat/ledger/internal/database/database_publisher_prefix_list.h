...
#ifndef HUHILEDGER_DATABASE_DATABASE_PUBLISHER_PREFIX_LIST_H_
#define HUHILEDGER_DATABASE_DATABASE_PUBLISHER_PREFIX_LIST_H_
...
#endif  // HUHILEDGER_DATABASE_DATABASE_PUBLISHER_PREFIX_LIST_H_
