...
#ifndef HUHILEDGER_DATABASE_DATABASE_UNBLINDED_TOKEN_H_
#define HUHILEDGER_DATABASE_DATABASE_UNBLINDED_TOKEN_H_
...
#endif  // HUHILEDGER_DATABASE_DATABASE_UNBLINDED_TOKEN_H_
