...
#ifndef HUHILEDGER_DATABASE_DATABASE_SERVER_PUBLISHER_AMOUNTS_H_
#define HUHILEDGER_DATABASE_DATABASE_SERVER_PUBLISHER_AMOUNTS_H_
...
#endif  // HUHILEDGER_DATABASE_DATABASE_SERVER_PUBLISHER_AMOUNTS_H_
