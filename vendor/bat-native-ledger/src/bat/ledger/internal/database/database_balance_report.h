...
#ifndef HUHILEDGER_DATABASE_DATABASE_BALANCE_REPORT_H_
#define HUHILEDGER_DATABASE_DATABASE_BALANCE_REPORT_H_
...
#endif  // HUHILEDGER_DATABASE_DATABASE_BALANCE_REPORT_H_
