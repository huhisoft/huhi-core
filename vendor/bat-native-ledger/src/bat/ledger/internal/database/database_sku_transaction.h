...
#ifndef HUHILEDGER_DATABASE_DATABASE_SKU_TRANSACTION_H_
#define HUHILEDGER_DATABASE_DATABASE_SKU_TRANSACTION_H_
...
#endif  // HUHILEDGER_DATABASE_DATABASE_SKU_TRANSACTION_H_
