...
#ifndef HUHILEDGER_DATABASE_DATABASE_CONTRIBUTION_QUEUE_H_
#define HUHILEDGER_DATABASE_DATABASE_CONTRIBUTION_QUEUE_H_
...
#endif  // HUHILEDGER_DATABASE_DATABASE_CONTRIBUTION_QUEUE_H_
