...
#ifndef HUHILEDGER_DATABASE_DATABASE_ACTIVITY_INFO_H_
#define HUHILEDGER_DATABASE_DATABASE_ACTIVITY_INFO_H_
...
#endif  // HUHILEDGER_DATABASE_DATABASE_ACTIVITY_INFO_H_
