...
#ifndef HUHILEDGER_DATABASE_MIGRATION_MIGRATION_V18_H_
#define HUHILEDGER_DATABASE_MIGRATION_MIGRATION_V18_H_
...
#endif  // HUHILEDGER_DATABASE_MIGRATION_MIGRATION_V18_H_
