...
#ifndef HUHILEDGER_DATABASE_DATABASE_SKU_ORDER_ITEMS_H_
#define HUHILEDGER_DATABASE_DATABASE_SKU_ORDER_ITEMS_H_
...
#endif  // HUHILEDGER_DATABASE_DATABASE_SKU_ORDER_ITEMS_H_
