...
#ifndef HUHILEDGER_DATABASE__DATABASE_SERVER_PUBLISHER_BANNER_H_
#define HUHILEDGER_DATABASE__DATABASE_SERVER_PUBLISHER_BANNER_H_
...
#endif  // HUHILEDGER_DATABASE__DATABASE_SERVER_PUBLISHER_BANNER_H_
