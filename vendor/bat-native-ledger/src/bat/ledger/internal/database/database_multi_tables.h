...
#ifndef HUHILEDGER_DATABASE_DATABASE_MULTI_TABLES_H_
#define HUHILEDGER_DATABASE_DATABASE_MULTI_TABLES_H_
...
#endif  // HUHILEDGER_DATABASE_DATABASE_MULTI_TABLES_H_
