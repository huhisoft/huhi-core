...
#ifndef HUHILEDGER_RECOVERY_RECOVERY_EMPTY_BALANCE_H_
#define HUHILEDGER_RECOVERY_RECOVERY_EMPTY_BALANCE_H_
...
#endif  // HUHILEDGER_RECOVERY_RECOVERY_EMPTY_BALANCE_H_
