...
#ifndef HUHILEDGER_MEDIA_YOUTUBE_H_
#define HUHILEDGER_MEDIA_YOUTUBE_H_
...
class YouTube {
 ...
 private:
  ...
  void OnMediaPublisherActivity(ledger::type::Result result,
...
#endif  // HUHILEDGER_MEDIA_YOUTUBE_H_
