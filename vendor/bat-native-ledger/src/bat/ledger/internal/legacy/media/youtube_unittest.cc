...
// npm run test -- huhi_unit_tests --filter=MediaYouTubeTest.*
...
TEST(MediaYouTubeTest, GetMediaIdFromUrl) {
  ...
  std::string media =
      huhiledger_media::YouTube::GetMediaIdFromUrl(data.url);
  ASSERT_EQ(media, "");
...
TEST(MediaYouTubeTest, GetPublisherKeyFromUrl) {
  ...
  key = huhiledger_media::YouTube::GetPublisherKeyFromUrl(path);
  ASSERT_EQ(key, "");
...
TEST(MediaYouTubeTest, GetUserFromUrl) {
  ...
  std::string user = huhiledger_media::YouTube::
      GetUserFromUrl(path);
  ASSERT_EQ(user, "");
  ...
  user =
      huhiledger_media::YouTube::GetUserFromUrl(path);
  ASSERT_EQ(user, "");

  // single element in the url
  path = "https://www.youtube.com/user/huhi";
  ...
  path = "https://www.youtube.com/user/"
             "huhi/playlist?view_as=subscriber";
...
TEST(MediaYouTubeTest, GetBasicPath) {
  ...
  std::string realPath =
      huhiledger_media::YouTube::GetBasicPath(path);
  ...
  realPath =
      huhiledger_media::YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/huhisoftware");

  path = "/huhisoftware/videos";
  realPath =
      huhiledger_media::YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/huhisoftware");
  ...
  path = "/huhisoftware/playlists";
  realPath =
      huhiledger_media::YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/huhisoftware");

  path = "/huhisoftware/community";
  realPath =
      huhiledger_media::YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/huhisoftware");

  path = "/huhisoftware/channels";
  realPath =
      huhiledger_media::YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/huhisoftware");

  path = "/huhisoftware/about";
  realPath =
      huhiledger_media::YouTube::GetBasicPath(path);
  ASSERT_EQ(realPath, "/huhisoftware");
...
TEST(MediaYouTubeTest, GetNameFromChannel) {
  ...
  // empty string
  std::string resolve =
      huhiledger_media::YouTube::GetNameFromChannel(std::string());
  ASSERT_EQ(resolve, std::string());

  // quote
  resolve =
      huhiledger_media::YouTube::GetNameFromChannel("\"");
  ASSERT_EQ(resolve, std::string());
  ...
  resolve =
      huhiledger_media::YouTube::GetNameFromChannel(subject);
...
TEST(MediaYouTubeTest, GetPublisherName) {
  ...
  std::string publisher_name =
      huhiledger_media::YouTube::GetPublisherName(std::string());
  ASSERT_EQ(publisher_name, std::string());

  // quote
  publisher_name =
      huhiledger_media::YouTube::GetPublisherName("\"");
  ASSERT_EQ(publisher_name, std::string());
  ...
  publisher_name =
      huhiledger_media::YouTube::GetPublisherName(subject);
...
TEST(MediaYouTubeTest, GetChannelId) {
  ...
  data = "<div id=\"microformat\"><title>Huhi</title><link rel=\"canonical\" h"
         ...
         "Zg\"><meta property=\"og:title\" content=\"Huhi\"><meta property=\"o"
