...
const char kDevelopment[] = "https://api.rewards.huhi.software";
const char kStaging[] = "https://api.rewards.huhisoft.com";
const char kProduction[] = "https://api.rewards.huhisoft.com";
