...
#ifndef HUHILEDGER_ENDPOINT_PAYMENT_PAYMENT_SERVER_H_
#define HUHILEDGER_ENDPOINT_PAYMENT_PAYMENT_SERVER_H_
...
#endif  // HUHILEDGER_ENDPOINT_PAYMENT_PAYMENT_SERVER_H_
