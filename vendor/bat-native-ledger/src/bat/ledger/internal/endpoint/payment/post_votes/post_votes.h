...
#ifndef HUHILEDGER_ENDPOINT_PAYMENT_POST_VOTES_POST_VOTES_H_
#define HUHILEDGER_ENDPOINT_PAYMENT_POST_VOTES_POST_VOTES_H_
...
#endif  // HUHILEDGER_ENDPOINT_PAYMENT_POST_VOTES_POST_VOTES_H_
