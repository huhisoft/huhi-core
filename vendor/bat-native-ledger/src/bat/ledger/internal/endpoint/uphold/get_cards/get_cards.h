...
#ifndef HUHILEDGER_ENDPOINT_UPHOLD_GET_CARDS_GET_CARDS_H_
#define HUHILEDGER_ENDPOINT_UPHOLD_GET_CARDS_GET_CARDS_H_
...
//     "label": "Twitter - User - Huhi Rewards",
...
#endif  // HUHILEDGER_ENDPOINT_UPHOLD_GET_CARDS_GET_CARDS_H_
