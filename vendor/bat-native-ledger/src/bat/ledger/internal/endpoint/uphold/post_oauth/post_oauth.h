...
#ifndef HUHILEDGER_ENDPOINT_UPHOLD_POST_OAUTH_POST_OAUTH_H_
#define HUHILEDGER_ENDPOINT_UPHOLD_POST_OAUTH_POST_OAUTH_H_
...
#endif  // HUHILEDGER_ENDPOINT_UPHOLD_POST_OAUTH_POST_OAUTH_H_
