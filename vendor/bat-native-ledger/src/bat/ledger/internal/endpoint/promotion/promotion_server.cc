...
PromotionServer::PromotionServer(LedgerImpl* ledger):
    ...
    post_wallet_huhi_(std::make_unique<promotion::PostWalletHuhi>(ledger)),
...
promotion::PostWalletHuhi* PromotionServer::post_wallet_huhi() const {
  return post_wallet_huhi_.get();
}
