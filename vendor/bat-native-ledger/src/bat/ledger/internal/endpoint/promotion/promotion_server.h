...
#ifndef HUHILEDGER_ENDPOINT_PROMOTION_PROMOTION_SERVER_H_
#define HUHILEDGER_ENDPOINT_PROMOTION_PROMOTION_SERVER_H_
...
class PromotionServer {
 public:
  ...
  promotion::PostWalletHuhi* post_wallet_huhi() const;
 ...
 private:
  ...
  std::unique_ptr<promotion::PostWalletHuhi> post_wallet_huhi_;
...
#endif  // HUHILEDGER_ENDPOINT_PROMOTION_PROMOTION_SERVER_H_
