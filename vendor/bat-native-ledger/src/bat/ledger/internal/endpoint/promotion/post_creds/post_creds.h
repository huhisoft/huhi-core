...
#ifndef HUHILEDGER_ENDPOINT_PROMOTION_POST_CREDS_POST_CREDS_H_
#define HUHILEDGER_ENDPOINT_PROMOTION_POST_CREDS_POST_CREDS_H_
...
#endif  // HUHILEDGER_ENDPOINT_PROMOTION_POST_CREDS_POST_CREDS_H_
