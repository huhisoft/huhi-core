...
@interface BATHuhiAds () <NativeAdsClientBridge> {
...
+ (BATHuhiAdsBuildChannel *)buildChannel
{
  auto build_channel = [[BATHuhiAdsBuildChannel alloc] init];
...
+ (void)setBuildChannel:(BATHuhiAdsBuildChannel *)buildChannel
{
...
- (BOOL)registerUserModelsForLanguageCode:(NSString *)languageCode
{
  ...
  BLOG(1, @"Registering Huhi User Model Installer (%@) with id %@", languageCode, languageCodeUserModelId);
...
- (BOOL)registerUserModelsForCountryCode:(NSString *)countryCode
{
  ...
  BLOG(1, @"Registering Huhi User Model Installer (%@) with id %@", countryCode, countryCodeUserModelId);
...
{
  const auto bundle = [NSBundle bundleForClass:[BATHuhiAds class]];
