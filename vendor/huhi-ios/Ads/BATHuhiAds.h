...
@class BATAdNotification, BATHuhiAds, BATHuhiLedger;

NS_SWIFT_NAME(HuhiAdsNotificationHandler)
@protocol BATHuhiAdsNotificationHandler
@required
...
NS_SWIFT_NAME(HuhiAds)
@interface BATHuhiAds : NSObject
...
@property (nonatomic, weak, nullable) id<BATHuhiAdsNotificationHandler> notificationsHandler;
...
@property (nonatomic, class) BATHuhiAdsBuildChannel *buildChannel;
...
/// Whether or not Huhi Ads is enabled
