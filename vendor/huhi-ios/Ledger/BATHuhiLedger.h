...
extern NSString * const BATHuhiLedgerErrorDomain NS_SWIFT_NAME(HuhiLedgerErrorDomain);

extern NSNotificationName const BATHuhiLedgerNotificationAdded NS_SWIFT_NAME(HuhiLedger.NotificationAdded);

typedef NSString *BATHuhiGeneralLedgerNotificationID NS_SWIFT_NAME(GeneralLedgerNotificationID) NS_STRING_ENUM;
extern BATHuhiGeneralLedgerNotificationID const BATHuhiGeneralLedgerNotificationIDWalletNowVerified;
extern BATHuhiGeneralLedgerNotificationID const BATHuhiGeneralLedgerNotificationIDWalletDisconnected;

NS_SWIFT_NAME(HuhiLedger)
@interface BATHuhiLedger : NSObject

@property (nonatomic, weak) BATHuhiAds *ads;

@property (nonatomic, copy, nullable) BATFaviconFetcher faviconFetcher;

/// Create a huhi ledger that will read and write its state to the given path
...
///
/// Use `BATHuhiLedgerObserver` to retrieve a panel publisher if one is found
