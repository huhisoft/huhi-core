...
- (NSURL *)storeURL
{
  return [[self storeDirectoryURL] URLByAppendingPathComponent:@"HuhiRewards.sqlite"];
}
...
+ (BOOL)defaultStoreExists
{
  ...
  const auto storeURL = [directoryURL URLByAppendingPathComponent:@"HuhiRewards.sqlite"];
