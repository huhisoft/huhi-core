...
class BatAdsAllowNotificationsFrequencyCapTest : public ::testing::Test {
 protected:
  BatAdsAllowNotificationsFrequencyCapTest()
      : task_environment_(base::test::TaskEnvironment::TimeSource::MOCK_TIME),
        ...
        frequency_cap_(std::make_unique<
            AllowNotificationsFrequencyCap>(ads_.get())) {
  ...
  ~BatAdsAllowNotificationsFrequencyCapTest() override {
  ...
  std::unique_ptr<AllowNotificationsFrequencyCap> frequency_cap_;
