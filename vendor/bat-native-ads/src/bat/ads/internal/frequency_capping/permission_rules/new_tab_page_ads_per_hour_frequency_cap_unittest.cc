...
class BatAdsNewTabPageAdsPerHourFrequencyCapTest : public ::testing::Test {
 protected:
  BatAdsNewTabPageAdsPerHourFrequencyCapTest()
  ...
  ~BatAdsNewTabPageAdsPerHourFrequencyCapTest() override {
...
TEST_F(BatAdsNewTabPageAdsPerHourFrequencyCapTest,
  ...
  NewTabPageAdsPerHourFrequencyCap frequency_cap(ads_.get(), ad_events);
