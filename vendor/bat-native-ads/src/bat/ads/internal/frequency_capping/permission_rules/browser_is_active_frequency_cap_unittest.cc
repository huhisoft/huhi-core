...
class BatAdsBrowserIsActiveFrequencyCapTest : public ::testing::Test {
 protected:
  BatAdsBrowserIsActiveFrequencyCapTest()
      : task_environment_(base::test::TaskEnvironment::TimeSource::MOCK_TIME),
        ...
        frequency_cap_(std::make_unique<
            BrowserIsActiveFrequencyCap>(ads_.get())) {
  ...
  ~BatAdsBrowserIsActiveFrequencyCapTest() override {
  ...
  std::unique_ptr<BrowserIsActiveFrequencyCap> frequency_cap_;
