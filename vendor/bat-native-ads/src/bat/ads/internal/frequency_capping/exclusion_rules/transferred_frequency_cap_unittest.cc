...
class BatAdsTransferredFrequencyCapTest : public ::testing::Test {
 protected:
  BatAdsTransferredFrequencyCapTest()
  ...
  ~BatAdsTransferredFrequencyCapTest() override {
...
TEST_F(BatAdsTransferredFrequencyCapTest,
  ...
  TransferredFrequencyCap frequency_cap(ads_.get(), ad_events);
