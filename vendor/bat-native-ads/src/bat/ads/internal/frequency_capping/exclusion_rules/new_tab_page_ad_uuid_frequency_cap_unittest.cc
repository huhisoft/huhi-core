...
class BatAdsNewTabPageAdUuidFrequencyCapTest : public ::testing::Test {
 protected:
  BatAdsNewTabPageAdUuidFrequencyCapTest()
  ...
  ~BatAdsNewTabPageAdUuidFrequencyCapTest() override {
...
TEST_F(BatAdsNewTabPageAdUuidFrequencyCapTest,
  ...
  NewTabPageAdUuidFrequencyCap frequency_cap(ads_.get(), ad_events);
