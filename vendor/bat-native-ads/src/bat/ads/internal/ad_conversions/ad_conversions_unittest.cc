...
TEST_F(BatAdsAdConversionsTest,
  ...
  info.type = "postview";
  info.url_pattern = "https://www.huhisoft.com/*";
  ...
  // Act
  get_ad_conversions()->MaybeConvert("https://www.huhisoft.com/signup");
...
TEST_F(BatAdsAdConversionsTest,
  ...
  info.creative_set_id = "3519f52c-46a4-4c48-9c2b-c264c0067f04";
  info.type = "postview";
  info.url_pattern = "https://www.huhisoft.com/signup/*";
  info.observation_window = 3;
  info.expiry_timestamp = CalculateExpiryTimestamp(info.observation_window);
  ad_conversions.push_back(info);
  ...
  // Act
  get_ad_conversions()->MaybeConvert("https://www.huhisoft.com/welcome");
...
TEST_F(BatAdsAdConversionsTest,
  ...
  // Act
  get_ad_conversions()->MaybeConvert("https://www.huhisoft.com/");
