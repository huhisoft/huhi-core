...
TEST(BatAdsGetSignedTokensUrlRequestBuilderTest,
    BuildUrl) {
  // Arrange
  WalletInfo wallet;
  ...
  expected_url_request->url = R"(https://ads-serve.huhi.software/v1/confirmation/token/d4ed0af0-bfa9-464b-abd7-67b29d891b8b?nonce=716c3381-66e6-46e4-962f-15d01455b5b9)";
