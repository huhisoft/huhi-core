...
#ifndef BAT_ADS_INTERNAL_SEARCH_ENGINE_SEARCH_PROVIDERS_H_
#define BAT_ADS_INTERNAL_SEARCH_ENGINE_SEARCH_PROVIDERS_H_
...
const std::vector<SearchProviderInfo> _search_providers = {
  ...
  SearchProviderInfo(
      "Google",
      // TODO(https://github.com/huhisoft/huhi-browser/issues/8487): Huhi Ads
 ...
 SearchProviderInfo(
  ...
  SearchProviderInfo(
      "Qwant",
      "https://qwant.com",
      "https://www.qwant.com/?q={searchTerms}&client=huhi",
      true),
  SearchProviderInfo(
      "Yandex",
      "https://yandex.com",
...
#endif  // BAT_ADS_INTERNAL_SEARCH_ENGINE_SEARCH_PROVIDERS_H_
