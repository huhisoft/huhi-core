...
#ifndef BAT_ADS_INTERNAL_LOCALE_SUPPORTED_COUNTRY_CODES_H_
#define BAT_ADS_INTERNAL_LOCALE_SUPPORTED_COUNTRY_CODES_H_
...
#endif  // BAT_ADS_INTERNAL_LOCALE_SUPPORTED_COUNTRY_CODES_H_
