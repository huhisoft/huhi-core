...
TEST_F(BatAdsConversionsDatabaseTableTest,
  ...
  info_1.url_pattern = "https://www.hnq.vn/*";
  ...
  info_2.url_pattern = "https://www.hnq.vn/signup/*";
...
TEST_F(BatAdsConversionsDatabaseTableTest,
  ...
  info.type = "postview";
  info.url_pattern = "https://www.hnq.vn/*";
...
TEST_F(BatAdsConversionsDatabaseTableTest,
  ...
  info_3.url_pattern = "https://www.hnq.vn/*";
...
TEST_F(BatAdsConversionsDatabaseTableTest,
  ...
  info_2.url_pattern = "https://www.hnq.vn/*";
  info_2.observation_window = 30;
  info_2.expiry_timestamp = CalculateExpiryTimestamp(info_2.observation_window);
  conversions.push_back(info_2);
