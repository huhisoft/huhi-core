...
class HuhiRandomDeterministicTest : public testing::Test {
 public:
  HuhiRandomDeterministicTest() {}
  ~HuhiRandomDeterministicTest() override {}
 private:
  DISALLOW_COPY_AND_ASSIGN(HuhiRandomDeterministicTest);
};

TEST_F(HuhiRandomDeterministicTest, Uniform_01) {
  using huhi_base::random::deterministic::Uniform_01;
...
TEST_F(HuhiRandomDeterministicTest, StdExponential) {
  using huhi_base::random::deterministic::StdExponential;
...
TEST_F(HuhiRandomDeterministicTest, Exponential) {
  using huhi_base::random::deterministic::Exponential;
...
TEST_F(HuhiRandomDeterministicTest, Geometric) {
  using huhi_base::random::deterministic::Geometric;
