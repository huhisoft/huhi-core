...
const int kHuhiActionGraphicSize = 18;
const int kHuhiActionRightMargin = 2;

const char huhi_extension_id[] = "mnojpmjdmbbfmejpflffifhffcmidifd";
const char huhi_rewards_extension_id[] = "jidkidbbcafjabdphckchenhfomhnfma";
...
const char huhi_webtorrent_extension_id[] = "lgjmpdmojkpocjcopdikifhejkkjglho";
const char huhi_webtorrent_extension_filename[] = "huhi_webtorrent.html";
const char huhi_webtorrent_extension_filename2[] = "huhi_webtorrent2.html";
