...
void HuhiRecordPermissionAction(ContentSettingsType permission,
...
#define HUHI_PERMISSIONUMAUTIL_RECORDPERMISSIONACTION \
  case ContentSettingsType::AUTOPLAY:                  \
    HuhiRecordPermissionAction(permission, action);   \
    break;

#include "../../../../components/permissions/permission_uma_util.cc"
#undef HUHI_PERMISSIONUMAUTIL_RECORDPERMISSIONACTION
