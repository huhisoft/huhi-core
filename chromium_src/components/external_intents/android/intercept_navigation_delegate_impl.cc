...
class HuhiInterceptNavigationDelegate : public InterceptNavigationDelegate {
 public:
  HuhiInterceptNavigationDelegate(JNIEnv* env,
                                   jobject jdelegate,
...
static void JNI_InterceptNavigationDelegateImpl_AssociateWithWebContents(
  ...
  InterceptNavigationDelegate::Associate(
      web_contents,
      std::make_unique<HuhiInterceptNavigationDelegate>(
          env, jdelegate,
