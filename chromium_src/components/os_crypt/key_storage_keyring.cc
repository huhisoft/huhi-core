...
#define HUHI_KEY_STORAGE_KEYRING_GET_KEY_IMPL                          \
  &kSchema, &password_c, "application", GetApplicationName(), nullptr); \
  if (false) Dummy(

#define HUHI_KEY_STORAGE_KEYRING_K_APPLICATION_NAME \
  const char kApplicationName[] = "huhi";

#include "../../../../components/os_crypt/key_storage_keyring.cc"
#undef HUHI_KEY_STORAGE_KEYRING_K_APPLICATION_NAME
#undef HUHI_KEY_STORAGE_KEYRING_GET_KEY_IMPL
