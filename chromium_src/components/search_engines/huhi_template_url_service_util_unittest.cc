...
class HuhiTemplateURLServiceUtilTest : public testing::Test {
 public:
  void SetUp() override {
...
TEST_F(HuhiTemplateURLServiceUtilTest, GetSearchProvidersUsingKeywordResult) {
...
TEST_F(HuhiTemplateURLServiceUtilTest,
...
TEST_F(HuhiTemplateURLServiceUtilTest, LocalizeEngineListMatchFound) {
  std::vector<TemplateURLPrepopulateData::HuhiPrepopulatedEngineID>
      list_with_yahoo = {
  ...
  std::vector<std::string> regions = {
      "AR", "AT", "AU", "BR", "CA", "CH", "CL", "CO", "DE", "DK", "ES",
      "FI", "FR", "HK", "ID", "IE", "IN", "IT", "MX", "MY", "NL", "NO",
      "NZ", "PE", "PH", "SE", "SG", "TH", "TW", "GB", "VE", "VN"};
  for (size_t i = 0; i < regions.size(); i++) {
    ...
    // of the HuhiPrepopulatedEngineID enum.
    // If this test breaks, check huhi_prepopulated_engines.h
    EXPECT_EQ(
        list_with_yahoo[0],
        (TemplateURLPrepopulateData::PREPOPULATED_ENGINE_ID_YAHOO + (i + 1)));
  }
}

TEST_F(HuhiTemplateURLServiceUtilTest, LocalizeEngineListMatchNotFound) {
  std::vector<TemplateURLPrepopulateData::HuhiPrepopulatedEngineID>
      list_with_yahoo = {
          TemplateURLPrepopulateData::PREPOPULATED_ENGINE_ID_YAHOO,
          TemplateURLPrepopulateData::PREPOPULATED_ENGINE_ID_QWANT,
