...
class HuhiFaviconDatabaseBrowserTest : public InProcessBrowserTest {
 public:
  HuhiFaviconDatabaseBrowserTest()
  ...
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestHandler(
        base::BindRepeating(&HuhiFaviconDatabaseBrowserTest::HandleRequest,
                            base::Unretained(this)));
    https_server_.RegisterRequestMonitor(
        base::BindRepeating(&HuhiFaviconDatabaseBrowserTest::SaveRequest,
                            base::Unretained(this)));
...
IN_PROC_BROWSER_TEST_F(HuhiFaviconDatabaseBrowserTest, SetRead1001) {
  ClearRequests();
