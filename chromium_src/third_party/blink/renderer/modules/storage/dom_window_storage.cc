...
HuhiDOMWindowStorage::HuhiDOMWindowStorage() {}
HuhiDOMWindowStorage::~HuhiDOMWindowStorage() {}

// static
StorageArea* HuhiDOMWindowStorage::sessionStorage(LocalDOMWindow& window,
                                              ExceptionState& exception_state) {
  auto* storage =
...
// static
StorageArea* HuhiDOMWindowStorage::localStorage(LocalDOMWindow& window,
                                            ExceptionState& exception_state) {
  auto* storage =
