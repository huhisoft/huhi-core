...
#define HUHI_HOST_PORT_PAIR_TO_STRING_ \
  ret = MaybeAddUsernameAndPassword(this, ret);

#define HUHI_HOST_PORT_PAIR_FROM_STRING_ \
  if (HasAuthentication(str)) \
    return FromStringWithAuthentication(str);

#define HUHI_HOST_PORT_PAIR_FROM_URL_ \
...
#undef HUHI_HOST_PORT_PAIR_TO_STRING_
#undef HUHI_HOST_PORT_PAIR_FROM_STRING_
#undef HUHI_HOST_PORT_PAIR_FROM_URL_
