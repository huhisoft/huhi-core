...
#ifndef HUHI_CHROMIUM_SRC_NET_SOCKET_SOCKS5_CLIENT_SOCKET_H_
#define HUHI_CHROMIUM_SRC_NET_SOCKET_SOCKS5_CLIENT_SOCKET_H_
...
#endif  // HUHI_CHROMIUM_SRC_NET_SOCKET_SOCKS5_CLIENT_SOCKET_H_
