...
bool ParseCertificatesFile(base::StringPiece certs_input, Pinsets* pinsets) {
  base::StringPiece huhi_certs = R"huhi_certs(TestSPKI
...
-----END CERTIFICATE-----)huhi_certs";

  return ParseCertificatesFile_ChromiumImpl(huhi_certs, pinsets);
}
...
bool ParseJSON(base::StringPiece json,
  ...
  base::StringPiece huhi_json = R"huhi_json({
    "pinsets": [
      {
        "name": "test",
        "static_spki_hashes": [
    ...
    "entries": [
      ...
      { "name": "ledger-staging.mercury.basicattentiontoken.org", "policy": "custom", "mode": "force-https", "pins": "huhi"},
      { "name": "ledger.rewards.huhi.software", "policy": "custom", "mode": "force-https", "pins": "huhi"},
      { "name": "balance.mercury.basicattentiontoken.org", "policy": "custom", "mode": "force-https", "pins": "huhi"},
      { "name": "balance-staging.mercury.basicattentiontoken.org", "policy": "custom", "mode": "force-https", "pins": "huhi"},
      { "name": "balance.rewards.huhi.software", "policy": "custom", "mode": "force-https", "pins": "huhi"},
  ...
  return ParseJSON_ChromiumImpl(huhi_json, entries, pinsets);
}
