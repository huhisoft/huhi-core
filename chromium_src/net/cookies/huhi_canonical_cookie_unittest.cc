...
TEST(HuhiCanonicalCookieTest, SetMaxExpiration) {
...
TEST(HuhiCanonicalCookieTest, AllowShorterThanMaxExpiration) {
  GURL url("https://www.example.com/test");
...
TEST(HuhiCanonicalCookieTest, SetHTTPOnlyMaxExpiration) {
  GURL url("https://www.example.com/test");
...
TEST(HuhiCanonicalCookieTest, NoExpirationCookie) {
  GURL url("https://www.example.com/test");
