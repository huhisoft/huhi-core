...
class HuhiSaveCardBubbleControllerImplTest : public InProcessBrowserTest {
 public:
  HuhiSaveCardBubbleControllerImplTest() {}
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(HuhiSaveCardBubbleControllerImplTest);
};

// Tests that requesting to open signin promo bubble doesn't result in the
// bubble being shown.
IN_PROC_BROWSER_TEST_F(HuhiSaveCardBubbleControllerImplTest, NoSignInPromo) {
  ShowUi();
