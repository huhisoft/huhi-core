...
#define ExternalProcessImporterHost HuhiExternalProcessImporterHost
...
#define HUHI_SEND_BROWSER_PROFILE_DATA                                        \
...
#undef HUHI_IMPORT_DATA
#undef HUHI_SEND_BROWSER_PROFILE_DATA
