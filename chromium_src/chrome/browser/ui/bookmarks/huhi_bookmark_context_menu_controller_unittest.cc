...
class HuhiBookmarkContextMenuControllerTest : public testing::Test {
 public:
  HuhiBookmarkContextMenuControllerTest() : model_(nullptr) {}
...
TEST_F(HuhiBookmarkContextMenuControllerTest,
