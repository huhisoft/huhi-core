...
void TabHoverCardBubbleView_ChromiumImpl::HuhiUpdateCardContent(
    const Tab* tab) {
  ...
  // Replace chrome:// with huhi://. Since this is purely in the UI we can
