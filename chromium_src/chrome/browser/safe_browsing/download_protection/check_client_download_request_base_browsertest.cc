...
class HuhiCheckClientDownloadRequestBaseBrowserTest
    : public InProcessBrowserTest {
 public:
  HuhiCheckClientDownloadRequestBaseBrowserTest()
...
IN_PROC_BROWSER_TEST_F(HuhiCheckClientDownloadRequestBaseBrowserTest,
                       FilterRequest) {
