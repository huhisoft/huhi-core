...
#if defined(OS_MAC)
#define CHROMIUM_PRODUCT_STRING HUHI_PRODUCT_STRING
#define PRODUCT_STRING HUHI_PRODUCT_STRING
...
const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("huhi");
const base::FilePath::CharType kBrowserProcessExecutableNameChromium[] =
    FPL("");
const base::FilePath::CharType kHelperProcessExecutableName[] =
...
#elif defined(OS_ANDROID)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("huhi");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("huhi");
const base::FilePath::CharType kBrowserProcessExecutablePathChromium[] =
    FPL("huhi");
const base::FilePath::CharType kHelperProcessExecutablePathChromium[] =
    FPL("huhi");
