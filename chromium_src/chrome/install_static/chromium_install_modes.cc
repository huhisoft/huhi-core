...
// Brand-specific constants and install modes for Huhi.
...
const wchar_t kCompanyPathName[] = L"HuhiSoftware";

#if defined(OFFICIAL_BUILD)
const wchar_t kProductPathName[] = L"Huhi-Browser";
#else
const wchar_t kProductPathName[] = L"Huhi-Browser-Development";
#endif
...
const InstallConstants kInstallModes[] = {
    // The primary install mode for stable Huhi.
    {
        ...
        L"Huhi",                           // A distinct base_app_name.
        L"Huhi",                           // A distinct base_app_id.
        L"HuhiHTML",                              // ProgID prefix.
        L"Huhi HTML Document",                    // ProgID description.
    ...
    // A secondary install mode for Huhi Beta
    {
        sizeof(kInstallModes[0]),
        ...
        L"Huhi Beta",                      // A distinct base_app_name.
        L"HuhiBeta",                              // A distinct base_app_id.
        L"HuhiBHTML",                             // ProgID prefix.
        L"Huhi Beta HTML Document",               // ProgID description.
    ...
    // A secondary install mode for Huhi Dev
    {
        sizeof(kInstallModes[0]),
        ...
        L"Huhi Dev",                       // A distinct base_app_name.
        L"HuhiDev",                               // A distinct base_app_id.
        L"HuhiDHTML",                             // ProgID prefix.
        L"Huhi Dev HTML Document",                // ProgID description.
    ...
    // A secondary install mode for Huhi SxS (canary).
    {
        sizeof(kInstallModes[0]),
        ...
        L"Huhi Nightly",                    // A distinct base_app_name.
        L"HuhiNightly",                            // A distinct base_app_id.
        L"HuhiSSHTM",                             // ProgID prefix.
        L"Huhi Nightly HTML Document",             // ProgID description.
...
#else
const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for Huhi developer build.
    {
        sizeof(kInstallModes[0]),
        ...
        L"",              // Empty install_suffix for the primary install mode.
        L"",              // No logo suffix for the primary install mode.
        L"",            // Empty app_guid since no integraion with Huhi Update.
        L"Huhi Development",  // A distinct base_app_name.
        L"HuhiDevelopment",   // A distinct base_app_id.
        L"HuhiDevHTM",                             // ProgID prefix.
        L"Huhi Development HTML Document",           // ProgID description.
